...
namespace XmSoft.AspNetCore.AliApi.Parser
{
    ...
    /// AliApi XML响应通用解释器。
    /// </summary>
    public class AliApiXmlParser<T> : IAliApiParser<T> where T : AliApiResponse
    {
        ...
        public SignItem GetSignItem(IAliApiRequest<T> request, string reponseBody)
        {
        ...
        private string GetRootElement(string body)
        {
            ...
            {
                throw new AliApiException("Invalid XML response format!");
            }
        }

        private static string GetSign(string body)
        {
            string signNodeName = "<" + AliApiConstants.SIGN + ">";
            string signEndNodeName = "</" + AliApiConstants.SIGN + ">";
        ...
        private static EncryptParseItem ParseEncryptItem(string body, string rootNode, int indexOfRootNode)
        {
            ...
            string xmlStartNode = "<" + AliApiConstants.ENCRYPT_NODE_NAME + ">";
            string xmlEndNode = "</" + AliApiConstants.ENCRYPT_NODE_NAME + ">";
