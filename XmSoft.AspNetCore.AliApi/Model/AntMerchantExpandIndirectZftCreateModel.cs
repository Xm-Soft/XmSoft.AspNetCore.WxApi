...
namespace XmSoft.AspNetCore.AliApi.Model
{
    ...
    /// </summary>
    [Serializable]
    public class AntMerchantExpandIndirectZftCreateModel : AliApiObject
    {
        /// <summary>
        /// 商户别名
        /// </summary>
        ...
        /// <summary>
        /// 外部业务号。比如某种业务标准外部订单号,比如交易外部订单号，代表服务商端自己订单号。用于做并发控制，防止一笔外部订单发起两次进件。非必要场景不要传入本字段，如要使用请说明场景及字段生成规则与蚂蚁金服对接人咨询。
        /// </summary>
