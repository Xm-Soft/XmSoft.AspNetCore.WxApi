...
{
    /// <summary>
    /// AliApi API: alipay.offline.market.shop.batchquery
    /// </summary>
    public class AlipayOfflineMarketShopBatchqueryRequest : IAliApiRequest<AlipayOfflineMarketShopBatchqueryResponse>
    {
        /// <summary>
