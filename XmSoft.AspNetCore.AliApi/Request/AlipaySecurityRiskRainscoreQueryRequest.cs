...
{
    /// <summary>
    /// AliApi API: alipay.security.risk.rainscore.query
    /// </summary>
    public class AlipaySecurityRiskRainscoreQueryRequest : IAliApiRequest<AlipaySecurityRiskRainscoreQueryResponse>
    {
        /// <summary>
