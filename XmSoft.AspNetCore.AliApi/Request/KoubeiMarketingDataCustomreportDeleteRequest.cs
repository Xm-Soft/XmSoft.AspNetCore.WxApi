...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.customreport.delete
    /// </summary>
    public class KoubeiMarketingDataCustomreportDeleteRequest : IAliApiRequest<KoubeiMarketingDataCustomreportDeleteResponse>
    {
        /// <summary>
        /// 自定义数据报表删除接口
        /// </summary>
