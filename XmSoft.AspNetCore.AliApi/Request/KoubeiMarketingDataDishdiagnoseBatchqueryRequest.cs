...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.dishdiagnose.batchquery
    /// </summary>
    public class KoubeiMarketingDataDishdiagnoseBatchqueryRequest : IAliApiRequest<KoubeiMarketingDataDishdiagnoseBatchqueryResponse>
    {
        /// <summary>
        /// 根据条件查询推荐菜
        /// </summary>
