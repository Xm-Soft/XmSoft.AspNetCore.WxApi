...
{
    /// <summary>
    /// AliApi API: ant.merchant.expand.item.status.modify
    /// </summary>
    public class AntMerchantExpandItemStatusModifyRequest : IAliApiRequest<AntMerchantExpandItemStatusModifyResponse>
    {
        /// <summary>
        /// 商品状态修改接口
        /// </summary>
