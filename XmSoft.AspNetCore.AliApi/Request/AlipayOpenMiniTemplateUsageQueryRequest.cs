...
{
    /// <summary>
    /// AliApi API: alipay.open.mini.template.usage.query
    /// </summary>
    public class AlipayOpenMiniTemplateUsageQueryRequest : IAliApiRequest<AlipayOpenMiniTemplateUsageQueryResponse>
    {
        /// <summary>
        /// 查询使用ISV模板的托管小程序列表
        /// </summary>
