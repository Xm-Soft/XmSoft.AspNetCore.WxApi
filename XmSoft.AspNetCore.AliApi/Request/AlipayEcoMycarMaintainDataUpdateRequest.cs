...
{
    /// <summary>
    /// AliApi API: alipay.eco.mycar.maintain.data.update
    /// </summary>
    public class AlipayEcoMycarMaintainDataUpdateRequest : IAliApiRequest<AlipayEcoMycarMaintainDataUpdateResponse>
    {
        /// <summary>
        /// 保养数据变更通知
        /// </summary>
