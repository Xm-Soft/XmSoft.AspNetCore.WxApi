...
{
    /// <summary>
    /// AliApi API: alipay.boss.fnc.userinvoiceinfo.query
    /// </summary>
    public class AlipayBossFncUserinvoiceinfoQueryRequest : IAliApiRequest<AlipayBossFncUserinvoiceinfoQueryResponse>
    {
        /// <summary>
        /// 根据PID获取相关的开票资料
        /// </summary>
