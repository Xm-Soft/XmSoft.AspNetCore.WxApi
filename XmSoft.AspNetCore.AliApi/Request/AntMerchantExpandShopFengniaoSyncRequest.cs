...
{
    /// <summary>
    /// AliApi API: ant.merchant.expand.shop.fengniao.sync
    /// </summary>
    public class AntMerchantExpandShopFengniaoSyncRequest : IAliApiRequest<AntMerchantExpandShopFengniaoSyncResponse>
    {
        /// <summary>
        /// 蜂鸟认证成功后同步支付信息确认
        /// </summary>
