...
{
    /// <summary>
    /// AliApi API: alipay.mobile.public.message.label.send
    /// </summary>
    public class AlipayMobilePublicMessageLabelSendRequest : IAliApiRequest<AlipayMobilePublicMessageLabelSendResponse>
    {
        /// <summary>
