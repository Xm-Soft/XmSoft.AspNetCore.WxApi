...
{
    /// <summary>
    /// AliApi API: koubei.marketing.campaign.item.batchquery
    /// </summary>
    public class KoubeiMarketingCampaignItemBatchqueryRequest : IAliApiRequest<KoubeiMarketingCampaignItemBatchqueryResponse>
    {
        /// <summary>
        /// 口碑商品券批量查询接口
        /// </summary>
