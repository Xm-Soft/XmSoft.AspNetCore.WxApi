...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.activity.bill.download
    /// </summary>
    public class KoubeiMarketingDataActivityBillDownloadRequest : IAliApiRequest<KoubeiMarketingDataActivityBillDownloadResponse>
    {
        /// <summary>
        /// 营销报表下载
        /// </summary>
