...
{
    /// <summary>
    /// AliApi API: alipay.eco.mycar.maintain.bizorder.query
    /// </summary>
    public class AlipayEcoMycarMaintainBizorderQueryRequest : IAliApiRequest<AlipayEcoMycarMaintainBizorderQueryResponse>
    {
        /// <summary>
        /// 订单查询接口
        /// </summary>
