...
{
    /// <summary>
    /// AliApi API: koubei.merchant.kbcloud.subuserinfo.query
    /// </summary>
    public class KoubeiMerchantKbcloudSubuserinfoQueryRequest : IAliApiRequest<KoubeiMerchantKbcloudSubuserinfoQueryResponse>
    {
        /// <summary>
        /// 查询口碑子账户信息列表
        /// </summary>
