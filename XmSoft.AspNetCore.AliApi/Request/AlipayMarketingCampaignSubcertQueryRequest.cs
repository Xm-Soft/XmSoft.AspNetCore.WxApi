...
{
    /// <summary>
    /// AliApi API: alipay.marketing.campaign.subcert.query
    /// </summary>
    public class AlipayMarketingCampaignSubcertQueryRequest : IAliApiRequest<AlipayMarketingCampaignSubcertQueryResponse>
    {
        /// <summary>
        /// 查询有效子凭证详细信息
        /// </summary>
