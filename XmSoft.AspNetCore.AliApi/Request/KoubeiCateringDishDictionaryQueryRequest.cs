...
{
    /// <summary>
    /// AliApi API: koubei.catering.dish.dictionary.query
    /// </summary>
    public class KoubeiCateringDishDictionaryQueryRequest : IAliApiRequest<KoubeiCateringDishDictionaryQueryResponse>
    {
        /// <summary>
        /// 口碑菜品字典数据查询
        /// </summary>
