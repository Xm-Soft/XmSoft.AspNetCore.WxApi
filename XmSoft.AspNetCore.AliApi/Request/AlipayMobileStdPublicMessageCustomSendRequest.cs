...
{
    /// <summary>
    /// AliApi API: alipay.mobile.std.public.message.custom.send
    /// </summary>
    public class AlipayMobileStdPublicMessageCustomSendRequest : IAliApiRequest<AlipayMobileStdPublicMessageCustomSendResponse>
    {
        /// <summary>
