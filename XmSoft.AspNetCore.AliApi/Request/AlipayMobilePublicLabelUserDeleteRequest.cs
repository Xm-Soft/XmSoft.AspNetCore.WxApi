...
{
    /// <summary>
    /// AliApi API: alipay.mobile.public.label.user.delete
    /// </summary>
    public class AlipayMobilePublicLabelUserDeleteRequest : IAliApiRequest<AlipayMobilePublicLabelUserDeleteResponse>
    {
        /// <summary>
