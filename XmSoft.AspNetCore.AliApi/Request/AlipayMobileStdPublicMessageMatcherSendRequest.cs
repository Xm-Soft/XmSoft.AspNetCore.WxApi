...
{
    /// <summary>
    /// AliApi API: alipay.mobile.std.public.message.matcher.send
    /// </summary>
    public class AlipayMobileStdPublicMessageMatcherSendRequest : IAliApiRequest<AlipayMobileStdPublicMessageMatcherSendResponse>
    {
        /// <summary>
