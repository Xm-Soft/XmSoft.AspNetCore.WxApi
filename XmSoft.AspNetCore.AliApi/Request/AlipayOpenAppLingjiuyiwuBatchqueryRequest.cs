...
{
    /// <summary>
    /// AliApi API: alipay.open.app.lingjiuyiwu.batchquery
    /// </summary>
    public class AlipayOpenAppLingjiuyiwuBatchqueryRequest : IAliApiRequest<AlipayOpenAppLingjiuyiwuBatchqueryResponse>
    {
