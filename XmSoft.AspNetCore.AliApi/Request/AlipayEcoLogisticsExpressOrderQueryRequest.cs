...
{
    /// <summary>
    /// AliApi API: alipay.eco.logistics.express.order.query
    /// </summary>
    public class AlipayEcoLogisticsExpressOrderQueryRequest : IAliApiRequest<AlipayEcoLogisticsExpressOrderQueryResponse>
    {
        /// <summary>
        /// 查询订单详情接口
        /// </summary>
