...
{
    /// <summary>
    /// AliApi API: alipay.data.aiservice.juneng.loan.query
    /// </summary>
    public class AlipayDataAiserviceJunengLoanQueryRequest : IAliApiRequest<AlipayDataAiserviceJunengLoanQueryResponse>
    {
        /// <summary>
        /// 查询用户的贷款资质
        /// </summary>
