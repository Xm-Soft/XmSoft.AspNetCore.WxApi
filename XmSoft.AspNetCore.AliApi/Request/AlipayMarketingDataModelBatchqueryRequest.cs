...
{
    /// <summary>
    /// AliApi API: alipay.marketing.data.model.batchquery
    /// </summary>
    public class AlipayMarketingDataModelBatchqueryRequest : IAliApiRequest<AlipayMarketingDataModelBatchqueryResponse>
    {
        /// <summary>
        /// 分页查询模型列表接口
        /// </summary>
