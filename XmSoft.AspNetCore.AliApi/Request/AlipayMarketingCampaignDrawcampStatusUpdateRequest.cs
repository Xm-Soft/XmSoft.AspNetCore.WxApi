...
{
    /// <summary>
    /// AliApi API: alipay.marketing.campaign.drawcamp.status.update
    /// </summary>
    public class AlipayMarketingCampaignDrawcampStatusUpdateRequest : IAliApiRequest<AlipayMarketingCampaignDrawcampStatusUpdateResponse>
    {
        /// <summary>
        /// 抽奖活动状态变更
        /// </summary>
