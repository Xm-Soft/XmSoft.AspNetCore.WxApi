...
{
    /// <summary>
    /// AliApi API: alipay.open.public.message.single.send
    /// </summary>
    public class AlipayOpenPublicMessageSingleSendRequest : IAliApiRequest<AlipayOpenPublicMessageSingleSendResponse>
    {
        /// <summary>
        /// 单发模板消息
        /// </summary>
