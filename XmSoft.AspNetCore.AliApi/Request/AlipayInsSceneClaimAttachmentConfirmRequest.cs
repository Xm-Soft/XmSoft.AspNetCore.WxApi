...
{
    /// <summary>
    /// AliApi API: alipay.ins.scene.claim.attachment.confirm
    /// </summary>
    public class AlipayInsSceneClaimAttachmentConfirmRequest : IAliApiRequest<AlipayInsSceneClaimAttachmentConfirmResponse>
    {
        /// <summary>
        /// 保险理赔案件材料上传确认
        /// </summary>
