...
{
    /// <summary>
    /// AliApi API: alipay.ebpp.prodmode.unionbank.query
    /// </summary>
    public class AlipayEbppProdmodeUnionbankQueryRequest : IAliApiRequest<AlipayEbppProdmodeUnionbankQueryResponse>
    {
        /// <summary>
        /// 联行信息查询接口
        /// </summary>
