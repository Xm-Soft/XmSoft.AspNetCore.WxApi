...
{
    /// <summary>
    /// AliApi API: alipay.ins.auto.fee.receive.confirm
    /// </summary>
    public class AlipayInsAutoFeeReceiveConfirmRequest : IAliApiRequest<AlipayInsAutoFeeReceiveConfirmResponse>
    {
        /// <summary>
        /// 车险向行业平台收费确认
        /// </summary>
