...
{
    /// <summary>
    /// AliApi API: alipay.ins.scene.application.cancel
    /// </summary>
    public class AlipayInsSceneApplicationCancelRequest : IAliApiRequest<AlipayInsSceneApplicationCancelResponse>
    {
        /// <summary>
        /// 投保订单出单撤销
        /// </summary>
