...
{
    /// <summary>
    /// AliApi API: alipay.user.invitetask.exchange.consult
    /// </summary>
    public class AlipayUserInvitetaskExchangeConsultRequest : IAliApiRequest<AlipayUserInvitetaskExchangeConsultResponse>
    {
        /// <summary>
        /// 拉新邀请任务兑换资格咨询
        /// </summary>
