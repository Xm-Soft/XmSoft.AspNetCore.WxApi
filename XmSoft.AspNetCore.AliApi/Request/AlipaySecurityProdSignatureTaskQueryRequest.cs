...
{
    /// <summary>
    /// AliApi API: alipay.security.prod.signature.task.query
    /// </summary>
    public class AlipaySecurityProdSignatureTaskQueryRequest : IAliApiRequest<AlipaySecurityProdSignatureTaskQueryResponse>
    {
        /// <summary>
        /// 支付宝可信电子签名结果查询
        /// </summary>
