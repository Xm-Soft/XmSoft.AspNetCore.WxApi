...
{
    /// <summary>
    /// AliApi API: mybank.credit.loanapply.data.upload
    /// </summary>
    public class MybankCreditLoanapplyDataUploadRequest : IAliApiRequest<MybankCreditLoanapplyDataUploadResponse>
    {
        /// <summary>
        /// 外部合作机构数据推送
        /// </summary>
