...
{
    /// <summary>
    /// AliApi API: alipay.open.public.message.custom.send
    /// </summary>
    public class AlipayOpenPublicMessageCustomSendRequest : IAliApiRequest<AlipayOpenPublicMessageCustomSendResponse>
    {
        /// <summary>
        /// 异步单发消息
        /// </summary>
