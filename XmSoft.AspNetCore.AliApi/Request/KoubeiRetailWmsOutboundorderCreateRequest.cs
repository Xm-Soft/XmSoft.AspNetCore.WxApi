...
{
    /// <summary>
    /// AliApi API: koubei.retail.wms.outboundorder.create
    /// </summary>
    public class KoubeiRetailWmsOutboundorderCreateRequest : IAliApiRequest<KoubeiRetailWmsOutboundorderCreateResponse>
    {
        /// <summary>
        /// 创建出库通知单
        /// </summary>
