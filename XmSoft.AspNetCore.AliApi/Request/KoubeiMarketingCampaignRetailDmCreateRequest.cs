...
{
    /// <summary>
    /// AliApi API: koubei.marketing.campaign.retail.dm.create
    /// </summary>
    public class KoubeiMarketingCampaignRetailDmCreateRequest : IAliApiRequest<KoubeiMarketingCampaignRetailDmCreateResponse>
    {
        /// <summary>
        /// 快消店铺展位内容创建接口
        /// </summary>
