...
{
    /// <summary>
    /// AliApi API: alipay.open.public.life.aboard.apply
    /// </summary>
    public class AlipayOpenPublicLifeAboardApplyRequest : IAliApiRequest<AlipayOpenPublicLifeAboardApplyResponse>
    {
