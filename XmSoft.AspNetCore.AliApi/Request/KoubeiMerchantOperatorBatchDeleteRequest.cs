...
{
    /// <summary>
    /// AliApi API: koubei.merchant.operator.batch.delete
    /// </summary>
    public class KoubeiMerchantOperatorBatchDeleteRequest : IAliApiRequest<KoubeiMerchantOperatorBatchDeleteResponse>
    {
        /// <summary>
        /// POS机-员工管理批量删除操作员接口
        /// </summary>
