...
{
    /// <summary>
    /// AliApi API: alipay.security.risk.riskprofile.query
    /// </summary>
    public class AlipaySecurityRiskRiskprofileQueryRequest : IAliApiRequest<AlipaySecurityRiskRiskprofileQueryResponse>
    {
        /// <summary>
