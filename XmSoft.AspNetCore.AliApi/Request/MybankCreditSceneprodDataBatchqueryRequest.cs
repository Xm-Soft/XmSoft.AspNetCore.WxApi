...
{
    /// <summary>
    /// AliApi API: mybank.credit.sceneprod.data.batchquery
    /// </summary>
    public class MybankCreditSceneprodDataBatchqueryRequest : IAliApiRequest<MybankCreditSceneprodDataBatchqueryResponse>
    {
        /// <summary>
        /// 场景金融资产信息查询接口
        /// </summary>
