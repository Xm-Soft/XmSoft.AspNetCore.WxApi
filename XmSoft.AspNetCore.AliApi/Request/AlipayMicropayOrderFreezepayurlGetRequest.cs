...
{
    /// <summary>
    /// AliApi API: alipay.micropay.order.freezepayurl.get
    /// </summary>
    public class AlipayMicropayOrderFreezepayurlGetRequest : IAliApiRequest<AlipayMicropayOrderFreezepayurlGetResponse>
    {
        /// <summary>
        /// 冻结订单号,创建冻结订单时支付宝返回的
        /// </summary>
