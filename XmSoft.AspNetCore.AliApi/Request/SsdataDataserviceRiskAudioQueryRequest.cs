...
{
    /// <summary>
    /// AliApi API: ssdata.dataservice.risk.audio.query
    /// </summary>
    public class SsdataDataserviceRiskAudioQueryRequest : IAliApiRequest<SsdataDataserviceRiskAudioQueryResponse>
    {
        /// <summary>
        /// 蚁盾音频内容识别结果
        /// </summary>
