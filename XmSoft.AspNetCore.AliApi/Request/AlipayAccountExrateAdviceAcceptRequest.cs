...
{
    /// <summary>
    /// AliApi API: alipay.account.exrate.advice.accept
    /// </summary>
    public class AlipayAccountExrateAdviceAcceptRequest : IAliApiRequest<AlipayAccountExrateAdviceAcceptResponse>
    {
        /// <summary>
        /// 标准的兑换交易受理接口
        /// </summary>
