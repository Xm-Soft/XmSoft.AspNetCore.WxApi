...
{
    /// <summary>
    /// AliApi API: koubei.advert.data.promotesummary.query
    /// </summary>
    public class KoubeiAdvertDataPromotesummaryQueryRequest : IAliApiRequest<KoubeiAdvertDataPromotesummaryQueryResponse>
    {
        /// <summary>
        /// 口碑客推广数据汇总查询
        /// </summary>
