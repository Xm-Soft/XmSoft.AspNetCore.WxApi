...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.trade.habbit.query
    /// </summary>
    public class KoubeiMarketingDataTradeHabbitQueryRequest : IAliApiRequest<KoubeiMarketingDataTradeHabbitQueryResponse>
    {
        /// <summary>
        /// 商户会员交易习惯查询接口
        /// </summary>
