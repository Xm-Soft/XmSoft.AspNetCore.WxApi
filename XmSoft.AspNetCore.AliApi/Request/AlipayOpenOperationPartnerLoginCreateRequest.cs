...
{
    /// <summary>
    /// AliApi API: alipay.open.operation.partner.login.create
    /// </summary>
    public class AlipayOpenOperationPartnerLoginCreateRequest : IAliApiRequest<AlipayOpenOperationPartnerLoginCreateResponse>
    {
        /// <summary>
        /// 服务商中心三方合作员工登录
        /// </summary>
