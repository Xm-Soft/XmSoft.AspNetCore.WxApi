...
{
    /// <summary>
    /// AliApi API: alipay.account.exrate.sentiment.data.send
    /// </summary>
    public class AlipayAccountExrateSentimentDataSendRequest : IAliApiRequest<AlipayAccountExrateSentimentDataSendResponse>
    {
        /// <summary>
        /// 国家制裁数据受理接口
        /// </summary>
