...
{
    /// <summary>
    /// AliApi API: koubei.marketing.campaign.benefit.query
    /// </summary>
    public class KoubeiMarketingCampaignBenefitQueryRequest : IAliApiRequest<KoubeiMarketingCampaignBenefitQueryResponse>
    {
        /// <summary>
        /// 口碑权益查询接口
        /// </summary>
