...
{
    /// <summary>
    /// AliApi API: alipay.marketing.encode.shortlink.create
    /// </summary>
    public class AlipayMarketingEncodeShortlinkCreateRequest : IAliApiRequest<AlipayMarketingEncodeShortlinkCreateResponse>
    {
        /// <summary>
        /// 生成短连接开放接口
        /// </summary>
