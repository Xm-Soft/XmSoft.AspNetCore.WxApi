...
{
    /// <summary>
    /// AliApi API: alipay.marketing.campaign.cash.list.query
    /// </summary>
    public class AlipayMarketingCampaignCashListQueryRequest : IAliApiRequest<AlipayMarketingCampaignCashListQueryResponse>
    {
        /// <summary>
        /// 现金活动列表查询
        /// </summary>
