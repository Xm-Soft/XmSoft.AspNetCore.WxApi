...
{
    /// <summary>
    /// AliApi API: alipay.asset.voucherprod.charge.send
    /// </summary>
    public class AlipayAssetVoucherprodChargeSendRequest : IAliApiRequest<AlipayAssetVoucherprodChargeSendResponse>
    {
        /// <summary>
        /// 外部商户标准发卡并充值
        /// </summary>
