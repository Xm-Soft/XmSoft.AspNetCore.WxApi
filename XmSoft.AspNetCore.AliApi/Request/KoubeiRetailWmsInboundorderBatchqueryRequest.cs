...
{
    /// <summary>
    /// AliApi API: koubei.retail.wms.inboundorder.batchquery
    /// </summary>
    public class KoubeiRetailWmsInboundorderBatchqueryRequest : IAliApiRequest<KoubeiRetailWmsInboundorderBatchqueryResponse>
    {
        /// <summary>
        /// 入库通知单批量查询
        /// </summary>
