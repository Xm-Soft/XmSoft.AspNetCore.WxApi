...
{
    /// <summary>
    /// AliApi API: koubei.craftsman.data.provider.batchquery
    /// </summary>
    public class KoubeiCraftsmanDataProviderBatchqueryRequest : IAliApiRequest<KoubeiCraftsmanDataProviderBatchqueryResponse>
    {
        /// <summary>
        /// 手艺人信息批量查询接口
        /// </summary>
