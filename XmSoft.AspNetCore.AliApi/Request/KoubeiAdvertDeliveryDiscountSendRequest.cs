...
{
    /// <summary>
    /// AliApi API: koubei.advert.delivery.discount.send
    /// </summary>
    public class KoubeiAdvertDeliveryDiscountSendRequest : IAliApiRequest<KoubeiAdvertDeliveryDiscountSendResponse>
    {
        /// <summary>
        /// 口碑外部投放授权发券接口
        /// </summary>
