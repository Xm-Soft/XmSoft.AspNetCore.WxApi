...
{
    /// <summary>
    /// AliApi API: alipay.open.app.yilingersilingliu.query
    /// </summary>
    public class AlipayOpenAppYilingersilingliuQueryRequest : IAliApiRequest<AlipayOpenAppYilingersilingliuQueryResponse>
    {
