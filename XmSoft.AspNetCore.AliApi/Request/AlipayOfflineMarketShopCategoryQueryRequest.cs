...
{
    /// <summary>
    /// AliApi API: alipay.offline.market.shop.category.query
    /// </summary>
    public class AlipayOfflineMarketShopCategoryQueryRequest : IAliApiRequest<AlipayOfflineMarketShopCategoryQueryResponse>
    {
        /// <summary>
        /// 门店类目配置查询接口
        /// </summary>
