...
{
    /// <summary>
    /// AliApi API: alipay.ins.scene.product.sign.query
    /// </summary>
    public class AlipayInsSceneProductSignQueryRequest : IAliApiRequest<AlipayInsSceneProductSignQueryResponse>
    {
        /// <summary>
        /// 保险代扣协议签约查询
        /// </summary>
