...
{
    /// <summary>
    /// AliApi API: alipay.fund.studentloan.repay.query
    /// </summary>
    public class AlipayFundStudentloanRepayQueryRequest : IAliApiRequest<AlipayFundStudentloanRepayQueryResponse>
    {
        /// <summary>
        /// 国开行助学贷款还款计划查询接口
        /// </summary>
