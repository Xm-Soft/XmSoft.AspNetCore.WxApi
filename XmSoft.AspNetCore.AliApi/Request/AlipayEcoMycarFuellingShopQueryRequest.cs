...
{
    /// <summary>
    /// AliApi API: alipay.eco.mycar.fuelling.shop.query
    /// </summary>
    public class AlipayEcoMycarFuellingShopQueryRequest : IAliApiRequest<AlipayEcoMycarFuellingShopQueryResponse>
    {
        /// <summary>
        /// 加油站门店信息查询接口
        /// </summary>
