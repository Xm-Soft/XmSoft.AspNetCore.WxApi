...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.bizadviser.myreport.query
    /// </summary>
    public class KoubeiMarketingDataBizadviserMyreportQueryRequest : IAliApiRequest<KoubeiMarketingDataBizadviserMyreportQueryResponse>
    {
        /// <summary>
        /// 经营参谋数据报表处理器
        /// </summary>
