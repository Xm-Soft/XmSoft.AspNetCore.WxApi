...
{
    /// <summary>
    /// AliApi API: koubei.servindustry.exercise.record.sync
    /// </summary>
    public class KoubeiServindustryExerciseRecordSyncRequest : IAliApiRequest<KoubeiServindustryExerciseRecordSyncResponse>
    {
        /// <summary>
        /// 健身记录同步接口
        /// </summary>
