...
{
    /// <summary>
    /// AliApi API: alipay.open.public.matchuser.label.create
    /// </summary>
    public class AlipayOpenPublicMatchuserLabelCreateRequest : IAliApiRequest<AlipayOpenPublicMatchuserLabelCreateResponse>
    {
        /// <summary>
        /// 匹配用户标签添加接口
        /// </summary>
