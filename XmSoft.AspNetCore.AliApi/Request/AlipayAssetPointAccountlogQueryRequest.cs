...
{
    /// <summary>
    /// AliApi API: alipay.asset.point.accountlog.query
    /// </summary>
    public class AlipayAssetPointAccountlogQueryRequest : IAliApiRequest<AlipayAssetPointAccountlogQueryResponse>
    {
        /// <summary>
        /// 用户集分宝流水明细查询
        /// </summary>
