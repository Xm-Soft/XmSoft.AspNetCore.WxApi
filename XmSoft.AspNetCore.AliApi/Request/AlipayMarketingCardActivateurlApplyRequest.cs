...
{
    /// <summary>
    /// AliApi API: alipay.marketing.card.activateurl.apply
    /// </summary>
    public class AlipayMarketingCardActivateurlApplyRequest : IAliApiRequest<AlipayMarketingCardActivateurlApplyResponse>
    {
        /// <summary>
        /// 会员卡领卡链接获取接口
        /// </summary>
