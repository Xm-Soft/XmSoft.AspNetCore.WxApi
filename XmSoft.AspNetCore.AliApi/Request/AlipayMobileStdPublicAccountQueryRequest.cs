...
{
    /// <summary>
    /// AliApi API: alipay.mobile.std.public.account.query
    /// </summary>
    public class AlipayMobileStdPublicAccountQueryRequest : IAliApiRequest<AlipayMobileStdPublicAccountQueryResponse>
    {
        /// <summary>
