...
{
    /// <summary>
    /// AliApi API: alipay.mobile.std.public.menu.query
    /// </summary>
    public class AlipayMobileStdPublicMenuQueryRequest : IAliApiRequest<AlipayMobileStdPublicMenuQueryResponse>
    {
