...
{
    /// <summary>
    /// AliApi API: alipay.mobile.public.label.user.add
    /// </summary>
    public class AlipayMobilePublicLabelUserAddRequest : IAliApiRequest<AlipayMobilePublicLabelUserAddResponse>
    {
        /// <summary>
