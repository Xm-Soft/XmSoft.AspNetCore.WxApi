...
{
    /// <summary>
    /// AliApi API: koubei.trade.ticket.ticketcode.send
    /// </summary>
    public class KoubeiTradeTicketTicketcodeSendRequest : IAliApiRequest<KoubeiTradeTicketTicketcodeSendResponse>
    {
        /// <summary>
        /// 码商发码成功回调接口
        /// </summary>
