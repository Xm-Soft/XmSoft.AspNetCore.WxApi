...
{
    /// <summary>
    /// AliApi API: alipay.marketing.cdp.advertise.report.query
    /// </summary>
    public class AlipayMarketingCdpAdvertiseReportQueryRequest : IAliApiRequest<AlipayMarketingCdpAdvertiseReportQueryResponse>
    {
        /// <summary>
        /// 广告效果分析接口
        /// </summary>
