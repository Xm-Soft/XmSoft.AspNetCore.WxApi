...
{
    /// <summary>
    /// AliApi API: alipay.boss.prod.submerchant.create
    /// </summary>
    public class AlipayBossProdSubmerchantCreateRequest : IAliApiRequest<AlipayBossProdSubmerchantCreateResponse>
    {
        /// <summary>
        /// 银行二清商户入驻接口
        /// </summary>
