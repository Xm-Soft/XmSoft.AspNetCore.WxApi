...
{
    /// <summary>
    /// AliApi API: ssdata.dataservice.risk.antifraud.verify
    /// </summary>
    public class SsdataDataserviceRiskAntifraudVerifyRequest : IAliApiRequest<SsdataDataserviceRiskAntifraudVerifyResponse>
    {
        /// <summary>
        /// 蚁盾欺诈信息验证
        /// </summary>
