...
{
    /// <summary>
    /// AliApi API: alipay.pcredit.huabei.auth.order.query
    /// </summary>
    public class AlipayPcreditHuabeiAuthOrderQueryRequest : IAliApiRequest<AlipayPcreditHuabeiAuthOrderQueryResponse>
    {
        /// <summary>
        /// 花呗先享订单查询接口
        /// </summary>
