...
{
    /// <summary>
    /// AliApi API: alipay.user.account.device.info.upload
    /// </summary>
    public class AlipayUserAccountDeviceInfoUploadRequest : IAliApiRequest<AlipayUserAccountDeviceInfoUploadResponse>
    {
        /// <summary>
        /// 用户设备信息上报
        /// </summary>
