...
{
    /// <summary>
    /// AliApi API: alipay.offline.market.shop.public.bind
    /// </summary>
    public class AlipayOfflineMarketShopPublicBindRequest : IAliApiRequest<AlipayOfflineMarketShopPublicBindResponse>
    {
        /// <summary>
