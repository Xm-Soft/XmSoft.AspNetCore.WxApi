...
{
    /// <summary>
    /// AliApi API: alipay.ebpp.invoice.token.batchquery
    /// </summary>
    public class AlipayEbppInvoiceTokenBatchqueryRequest : IAliApiRequest<AlipayEbppInvoiceTokenBatchqueryResponse>
    {
        /// <summary>
        /// 根据查询令牌获取发票要素列表
        /// </summary>
