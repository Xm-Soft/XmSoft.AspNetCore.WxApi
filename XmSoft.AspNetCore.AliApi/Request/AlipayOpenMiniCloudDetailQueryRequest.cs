...
{
    /// <summary>
    /// AliApi API: alipay.open.mini.cloud.detail.query
    /// </summary>
    public class AlipayOpenMiniCloudDetailQueryRequest : IAliApiRequest<AlipayOpenMiniCloudDetailQueryResponse>
    {
        /// <summary>
