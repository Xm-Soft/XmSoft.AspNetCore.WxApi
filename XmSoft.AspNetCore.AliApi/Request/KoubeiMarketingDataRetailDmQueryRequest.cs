...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.retail.dm.query
    /// </summary>
    public class KoubeiMarketingDataRetailDmQueryRequest : IAliApiRequest<KoubeiMarketingDataRetailDmQueryResponse>
    {
        /// <summary>
        /// 快消店铺DM浏览数据查询接口
        /// </summary>
