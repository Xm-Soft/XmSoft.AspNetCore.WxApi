...
{
    /// <summary>
    /// AliApi API: koubei.catering.crowdgroup.condition.query
    /// </summary>
    public class KoubeiCateringCrowdgroupConditionQueryRequest : IAliApiRequest<KoubeiCateringCrowdgroupConditionQueryResponse>
    {
        /// <summary>
        /// isv创建用户规则查询
        /// </summary>
