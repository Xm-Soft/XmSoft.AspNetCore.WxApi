...
{
    /// <summary>
    /// AliApi API: alipay.marketing.tool.fengdie.template.query
    /// </summary>
    public class AlipayMarketingToolFengdieTemplateQueryRequest : IAliApiRequest<AlipayMarketingToolFengdieTemplateQueryResponse>
    {
        /// <summary>
        /// 查询当前用户可用的模板列表
        /// </summary>
