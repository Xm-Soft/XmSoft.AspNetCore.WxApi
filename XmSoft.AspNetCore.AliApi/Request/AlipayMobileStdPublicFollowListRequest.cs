...
{
    /// <summary>
    /// AliApi API: alipay.mobile.std.public.follow.list
    /// </summary>
    public class AlipayMobileStdPublicFollowListRequest : IAliApiRequest<AlipayMobileStdPublicFollowListResponse>
    {
        /// <summary>
