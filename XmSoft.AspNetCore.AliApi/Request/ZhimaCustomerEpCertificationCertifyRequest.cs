...
{
    /// <summary>
    /// AliApi API: zhima.customer.ep.certification.certify
    /// </summary>
    public class ZhimaCustomerEpCertificationCertifyRequest : IAliApiRequest<ZhimaCustomerEpCertificationCertifyResponse>
    {
        /// <summary>
        /// 企业认证引导(页面接口)
        /// </summary>
