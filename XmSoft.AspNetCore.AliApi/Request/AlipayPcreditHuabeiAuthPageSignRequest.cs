...
{
    /// <summary>
    /// AliApi API: alipay.pcredit.huabei.auth.page.sign
    /// </summary>
    public class AlipayPcreditHuabeiAuthPageSignRequest : IAliApiRequest<AlipayPcreditHuabeiAuthPageSignResponse>
    {
        /// <summary>
        /// 花呗额度授权协议页面签约接口
        /// </summary>
