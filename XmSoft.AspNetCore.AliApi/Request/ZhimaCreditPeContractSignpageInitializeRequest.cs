...
{
    /// <summary>
    /// AliApi API: zhima.credit.pe.contract.signpage.initialize
    /// </summary>
    public class ZhimaCreditPeContractSignpageInitializeRequest : IAliApiRequest<ZhimaCreditPeContractSignpageInitializeResponse>
    {
        /// <summary>
        /// 获取签约页面
        /// </summary>
