...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.alisis.report.batchquery
    /// </summary>
    public class KoubeiMarketingDataAlisisReportBatchqueryRequest : IAliApiRequest<KoubeiMarketingDataAlisisReportBatchqueryResponse>
    {
        /// <summary>
        /// 报表列表查询接口
        /// </summary>
