...
{
    /// <summary>
    /// AliApi API: alipay.overseas.travel.content.create
    /// </summary>
    public class AlipayOverseasTravelContentCreateRequest : IAliApiRequest<AlipayOverseasTravelContentCreateResponse>
    {
        /// <summary>
        /// 飞猪内容对接内容创建修改接口
        /// </summary>
