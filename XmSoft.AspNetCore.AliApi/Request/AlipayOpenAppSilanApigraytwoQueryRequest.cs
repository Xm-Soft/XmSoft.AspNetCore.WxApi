...
{
    /// <summary>
    /// AliApi API: alipay.open.app.silan.apigraytwo.query
    /// </summary>
    public class AlipayOpenAppSilanApigraytwoQueryRequest : IAliApiRequest<AlipayOpenAppSilanApigraytwoQueryResponse>
    {
