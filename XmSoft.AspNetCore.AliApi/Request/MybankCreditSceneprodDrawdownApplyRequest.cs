...
{
    /// <summary>
    /// AliApi API: mybank.credit.sceneprod.drawdown.apply
    /// </summary>
    public class MybankCreditSceneprodDrawdownApplyRequest : IAliApiRequest<MybankCreditSceneprodDrawdownApplyResponse>
    {
        /// <summary>
        /// 场景金融银行直投业务放款申请
        /// </summary>
