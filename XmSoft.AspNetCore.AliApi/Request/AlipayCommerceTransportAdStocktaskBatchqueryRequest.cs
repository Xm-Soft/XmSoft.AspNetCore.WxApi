...
{
    /// <summary>
    /// AliApi API: alipay.commerce.transport.ad.stocktask.batchquery
    /// </summary>
    public class AlipayCommerceTransportAdStocktaskBatchqueryRequest : IAliApiRequest<AlipayCommerceTransportAdStocktaskBatchqueryResponse>
    {
        /// <summary>
        /// 库存查询任务批量查询
        /// </summary>
