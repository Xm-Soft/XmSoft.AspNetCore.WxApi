...
{
    /// <summary>
    /// AliApi API: alipay.security.prod.signature.task.cancel
    /// </summary>
    public class AlipaySecurityProdSignatureTaskCancelRequest : IAliApiRequest<AlipaySecurityProdSignatureTaskCancelResponse>
    {
        /// <summary>
        /// 支付宝可信电子签名任务撤销
        /// </summary>
