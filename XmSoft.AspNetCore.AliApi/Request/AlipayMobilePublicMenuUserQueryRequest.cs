...
{
    /// <summary>
    /// AliApi API: alipay.mobile.public.menu.user.query
    /// </summary>
    public class AlipayMobilePublicMenuUserQueryRequest : IAliApiRequest<AlipayMobilePublicMenuUserQueryResponse>
    {
        /// <summary>
        /// 用户openId
        /// </summary>
