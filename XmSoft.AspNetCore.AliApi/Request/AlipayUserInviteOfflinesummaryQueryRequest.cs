...
{
    /// <summary>
    /// AliApi API: alipay.user.invite.offlinesummary.query
    /// </summary>
    public class AlipayUserInviteOfflinesummaryQueryRequest : IAliApiRequest<AlipayUserInviteOfflinesummaryQueryResponse>
    {
        /// <summary>
        /// 线下拉新结算汇总数据查询
        /// </summary>
