...
{
    /// <summary>
    /// AliApi API: koubei.marketing.campaign.item.query
    /// </summary>
    public class KoubeiMarketingCampaignItemQueryRequest : IAliApiRequest<KoubeiMarketingCampaignItemQueryResponse>
    {
        /// <summary>
        /// 商户商品券查询接口
        /// </summary>
