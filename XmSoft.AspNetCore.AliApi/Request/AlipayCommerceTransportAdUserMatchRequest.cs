...
{
    /// <summary>
    /// AliApi API: alipay.commerce.transport.ad.user.match
    /// </summary>
    public class AlipayCommerceTransportAdUserMatchRequest : IAliApiRequest<AlipayCommerceTransportAdUserMatchResponse>
    {
        /// <summary>
