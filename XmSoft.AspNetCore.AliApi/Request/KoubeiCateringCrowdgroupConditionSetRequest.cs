...
{
    /// <summary>
    /// AliApi API: koubei.catering.crowdgroup.condition.set
    /// </summary>
    public class KoubeiCateringCrowdgroupConditionSetRequest : IAliApiRequest<KoubeiCateringCrowdgroupConditionSetResponse>
    {
        /// <summary>
