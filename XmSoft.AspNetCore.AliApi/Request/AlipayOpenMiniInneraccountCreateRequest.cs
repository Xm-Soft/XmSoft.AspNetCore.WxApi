...
{
    /// <summary>
    /// AliApi API: alipay.open.mini.inneraccount.create
    /// </summary>
    public class AlipayOpenMiniInneraccountCreateRequest : IAliApiRequest<AlipayOpenMiniInneraccountCreateResponse>
    {
        /// <summary>
        /// 创建小程序管理员虚拟 ID
        /// </summary>
