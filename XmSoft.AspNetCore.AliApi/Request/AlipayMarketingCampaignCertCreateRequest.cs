...
{
    /// <summary>
    /// AliApi API: alipay.marketing.campaign.cert.create
    /// </summary>
    public class AlipayMarketingCampaignCertCreateRequest : IAliApiRequest<AlipayMarketingCampaignCertCreateResponse>
    {
        /// <summary>
        /// 营销抽奖活动凭证创建
        /// </summary>
