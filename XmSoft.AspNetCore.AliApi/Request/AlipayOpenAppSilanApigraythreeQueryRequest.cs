...
{
    /// <summary>
    /// AliApi API: alipay.open.app.silan.apigraythree.query
    /// </summary>
    public class AlipayOpenAppSilanApigraythreeQueryRequest : IAliApiRequest<AlipayOpenAppSilanApigraythreeQueryResponse>
    {
