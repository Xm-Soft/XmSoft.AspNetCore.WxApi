...
{
    /// <summary>
    /// AliApi API: alipay.user.invitetask.exchange.confirm
    /// </summary>
    public class AlipayUserInvitetaskExchangeConfirmRequest : IAliApiRequest<AlipayUserInvitetaskExchangeConfirmResponse>
    {
        /// <summary>
        /// 拉新邀请任务兑换确认
        /// </summary>
