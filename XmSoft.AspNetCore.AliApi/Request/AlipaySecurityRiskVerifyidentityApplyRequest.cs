...
{
    /// <summary>
    /// AliApi API: alipay.security.risk.verifyidentity.apply
    /// </summary>
    public class AlipaySecurityRiskVerifyidentityApplyRequest : IAliApiRequest<AlipaySecurityRiskVerifyidentityApplyResponse>
    {
        /// <summary>
        /// 核身可用性查询接口
        /// </summary>
