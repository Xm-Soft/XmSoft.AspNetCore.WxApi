...
{
    /// <summary>
    /// AliApi API: koubei.advert.delivery.discount.web.batchquery
    /// </summary>
    public class KoubeiAdvertDeliveryDiscountWebBatchqueryRequest : IAliApiRequest<KoubeiAdvertDeliveryDiscountWebBatchqueryResponse>
    {
        /// <summary>
        /// 口碑广告投放优惠查询接口
        /// </summary>
