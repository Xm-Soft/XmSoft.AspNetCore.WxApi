...
{
    /// <summary>
    /// AliApi API: alipay.open.public.life.label.batchquery
    /// </summary>
    public class AlipayOpenPublicLifeLabelBatchqueryRequest : IAliApiRequest<AlipayOpenPublicLifeLabelBatchqueryResponse>
    {
