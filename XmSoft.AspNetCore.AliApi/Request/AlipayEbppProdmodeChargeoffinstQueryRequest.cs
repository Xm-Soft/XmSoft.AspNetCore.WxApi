...
{
    /// <summary>
    /// AliApi API: alipay.ebpp.prodmode.chargeoffinst.query
    /// </summary>
    public class AlipayEbppProdmodeChargeoffinstQueryRequest : IAliApiRequest<AlipayEbppProdmodeChargeoffinstQueryResponse>
    {
        /// <summary>
        /// 查询销账机构列表
        /// </summary>
