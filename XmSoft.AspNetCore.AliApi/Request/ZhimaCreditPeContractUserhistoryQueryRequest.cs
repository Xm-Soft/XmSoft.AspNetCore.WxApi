...
{
    /// <summary>
    /// AliApi API: zhima.credit.pe.contract.userhistory.query
    /// </summary>
    public class ZhimaCreditPeContractUserhistoryQueryRequest : IAliApiRequest<ZhimaCreditPeContractUserhistoryQueryResponse>
    {
        /// <summary>
        /// 用户历史合约
        /// </summary>
