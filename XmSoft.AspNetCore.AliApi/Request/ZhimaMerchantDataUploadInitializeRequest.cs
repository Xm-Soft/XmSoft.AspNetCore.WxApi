...
{
    /// <summary>
    /// AliApi API: zhima.merchant.data.upload.initialize
    /// </summary>
    public class ZhimaMerchantDataUploadInitializeRequest : IAliApiRequest<ZhimaMerchantDataUploadInitializeResponse>
    {
        /// <summary>
        /// 芝麻数据传入初始化
        /// </summary>
