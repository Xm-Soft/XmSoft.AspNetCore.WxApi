...
{
    /// <summary>
    /// AliApi API: alipay.boss.fnc.invoicereceipt.create
    /// </summary>
    public class AlipayBossFncInvoicereceiptCreateRequest : IAliApiRequest<AlipayBossFncInvoicereceiptCreateResponse>
    {
        /// <summary>
        /// 账单变更同步接口
        /// </summary>
