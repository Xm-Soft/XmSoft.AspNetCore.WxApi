...
{
    /// <summary>
    /// AliApi API: alipay.open.public.partner.menu.operate
    /// </summary>
    public class AlipayOpenPublicPartnerMenuOperateRequest : IAliApiRequest<AlipayOpenPublicPartnerMenuOperateResponse>
    {
        /// <summary>
