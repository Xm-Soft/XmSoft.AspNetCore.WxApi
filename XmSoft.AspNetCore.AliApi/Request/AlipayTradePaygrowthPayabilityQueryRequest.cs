...
{
    /// <summary>
    /// AliApi API: alipay.trade.paygrowth.payability.query
    /// </summary>
    public class AlipayTradePaygrowthPayabilityQueryRequest : IAliApiRequest<AlipayTradePaygrowthPayabilityQueryResponse>
    {
        /// <summary>
        /// 查询用户支付宝账户支付能力
        /// </summary>
