...
{
    /// <summary>
    /// AliApi API: alipay.marketing.voucher.stock.create
    /// </summary>
    public class AlipayMarketingVoucherStockCreateRequest : IAliApiRequest<AlipayMarketingVoucherStockCreateResponse>
    {
        /// <summary>
        /// 外部商户券码券上传
        /// </summary>
