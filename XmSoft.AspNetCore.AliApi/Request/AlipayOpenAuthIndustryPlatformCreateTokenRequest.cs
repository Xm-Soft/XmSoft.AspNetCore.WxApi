...
{
    /// <summary>
    /// AliApi API: alipay.open.auth.industry.platform.create.token
    /// </summary>
    public class AlipayOpenAuthIndustryPlatformCreateTokenRequest : IAliApiRequest<AlipayOpenAuthIndustryPlatformCreateTokenResponse>
    {
        /// <summary>
        /// 行业平台获取授权码
        /// </summary>
