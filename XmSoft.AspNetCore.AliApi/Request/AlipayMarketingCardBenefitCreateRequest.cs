...
{
    /// <summary>
    /// AliApi API: alipay.marketing.card.benefit.create
    /// </summary>
    public class AlipayMarketingCardBenefitCreateRequest : IAliApiRequest<AlipayMarketingCardBenefitCreateResponse>
    {
        /// <summary>
        /// 会员卡模板外部权益创建
        /// </summary>
