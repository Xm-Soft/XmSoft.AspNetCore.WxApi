...
{
    /// <summary>
    /// AliApi API: alipay.data.dataservice.antlbs.crowd.match
    /// </summary>
    public class AlipayDataDataserviceAntlbsCrowdMatchRequest : IAliApiRequest<AlipayDataDataserviceAntlbsCrowdMatchResponse>
    {
        /// <summary>
        /// 查询用户匹配的客群信息
        /// </summary>
