...
{
    /// <summary>
    /// AliApi API: alipay.marketing.campaign.cash.status.modify
    /// </summary>
    public class AlipayMarketingCampaignCashStatusModifyRequest : IAliApiRequest<AlipayMarketingCampaignCashStatusModifyResponse>
    {
        /// <summary>
        /// 更改现金活动状态
        /// </summary>
