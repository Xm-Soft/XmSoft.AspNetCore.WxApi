...
{
    /// <summary>
    /// AliApi API: ant.merchant.expand.merchant.storelist.query
    /// </summary>
    public class AntMerchantExpandMerchantStorelistQueryRequest : IAliApiRequest<AntMerchantExpandMerchantStorelistQueryResponse>
    {
        /// <summary>
        /// 商户外部门店查询接口
        /// </summary>
