...
{
    /// <summary>
    /// AliApi API: koubei.catering.dish.estimated.sync
    /// </summary>
    public class KoubeiCateringDishEstimatedSyncRequest : IAliApiRequest<KoubeiCateringDishEstimatedSyncResponse>
    {
        /// <summary>
        /// 口碑菜品估清数据同步
        /// </summary>
