...
{
    /// <summary>
    /// AliApi API: alipay.ins.scene.product.agreement.query
    /// </summary>
    public class AlipayInsSceneProductAgreementQueryRequest : IAliApiRequest<AlipayInsSceneProductAgreementQueryResponse>
    {
        /// <summary>
        /// 商户产品协议签约查询
        /// </summary>
