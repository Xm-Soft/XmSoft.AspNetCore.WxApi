...
{
    /// <summary>
    /// AliApi API: alipay.ebpp.invoice.apply.result.sync
    /// </summary>
    public class AlipayEbppInvoiceApplyResultSyncRequest : IAliApiRequest<AlipayEbppInvoiceApplyResultSyncResponse>
    {
        /// <summary>
        /// 同步发票申请结果
        /// </summary>
