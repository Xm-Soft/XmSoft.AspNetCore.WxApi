...
{
    /// <summary>
    /// AliApi API: koubei.merchant.operator.role.create
    /// </summary>
    public class KoubeiMerchantOperatorRoleCreateRequest : IAliApiRequest<KoubeiMerchantOperatorRoleCreateResponse>
    {
        /// <summary>
        /// 口碑操作员角色新增或者修改
        /// </summary>
