...
{
    /// <summary>
    /// AliApi API: koubei.marketing.campaign.retail.dm.query
    /// </summary>
    public class KoubeiMarketingCampaignRetailDmQueryRequest : IAliApiRequest<KoubeiMarketingCampaignRetailDmQueryResponse>
    {
        /// <summary>
        /// 快消店铺展位内容查询接口
        /// </summary>
