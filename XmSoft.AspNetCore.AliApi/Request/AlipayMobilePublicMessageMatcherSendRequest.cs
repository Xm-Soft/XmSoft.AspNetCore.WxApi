...
{
    /// <summary>
    /// AliApi API: alipay.mobile.public.message.matcher.send
    /// </summary>
    public class AlipayMobilePublicMessageMatcherSendRequest : IAliApiRequest<AlipayMobilePublicMessageMatcherSendResponse>
    {
        /// <summary>
