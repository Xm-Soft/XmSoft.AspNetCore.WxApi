...
{
    /// <summary>
    /// AliApi API: alipay.user.scene.cooperation.consult
    /// </summary>
    public class AlipayUserSceneCooperationConsultRequest : IAliApiRequest<AlipayUserSceneCooperationConsultResponse>
    {
        /// <summary>
        /// 支付宝用户场景合作咨询
        /// </summary>
