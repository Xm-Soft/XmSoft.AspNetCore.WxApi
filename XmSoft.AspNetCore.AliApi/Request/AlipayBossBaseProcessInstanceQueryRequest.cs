...
{
    /// <summary>
    /// AliApi API: alipay.boss.base.process.instance.query
    /// </summary>
    public class AlipayBossBaseProcessInstanceQueryRequest : IAliApiRequest<AlipayBossBaseProcessInstanceQueryResponse>
    {
        /// <summary>
        /// 查询流程实例
        /// </summary>
