...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.smartmanagement.diagnose
    /// </summary>
    public class KoubeiMarketingDataSmartmanagementDiagnoseRequest : IAliApiRequest<KoubeiMarketingDataSmartmanagementDiagnoseResponse>
    {
