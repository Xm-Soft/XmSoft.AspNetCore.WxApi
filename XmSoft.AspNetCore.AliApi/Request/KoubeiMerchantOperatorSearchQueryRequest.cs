...
{
    /// <summary>
    /// AliApi API: koubei.merchant.operator.search.query
    /// </summary>
    public class KoubeiMerchantOperatorSearchQueryRequest : IAliApiRequest<KoubeiMerchantOperatorSearchQueryResponse>
    {
        /// <summary>
        /// 操作员列表查询
        /// </summary>
