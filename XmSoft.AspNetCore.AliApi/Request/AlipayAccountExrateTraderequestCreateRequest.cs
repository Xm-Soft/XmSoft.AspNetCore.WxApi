...
{
    /// <summary>
    /// AliApi API: alipay.account.exrate.traderequest.create
    /// </summary>
    public class AlipayAccountExrateTraderequestCreateRequest : IAliApiRequest<AlipayAccountExrateTraderequestCreateResponse>
    {
        /// <summary>
        /// 受理外汇交易请求
        /// </summary>
