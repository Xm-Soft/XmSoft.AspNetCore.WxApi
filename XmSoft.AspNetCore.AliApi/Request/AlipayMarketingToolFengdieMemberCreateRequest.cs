...
{
    /// <summary>
    /// AliApi API: alipay.marketing.tool.fengdie.member.create
    /// </summary>
    public class AlipayMarketingToolFengdieMemberCreateRequest : IAliApiRequest<AlipayMarketingToolFengdieMemberCreateResponse>
    {
        /// <summary>
        /// 创建云凤蝶空间成员
        /// </summary>
