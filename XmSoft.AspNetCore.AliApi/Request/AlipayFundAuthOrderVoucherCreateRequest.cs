...
{
    /// <summary>
    /// AliApi API: alipay.fund.auth.order.voucher.create
    /// </summary>
    public class AlipayFundAuthOrderVoucherCreateRequest : IAliApiRequest<AlipayFundAuthOrderVoucherCreateResponse>
    {
        /// <summary>
        /// 资金授权发码接口
        /// </summary>
