...
{
    /// <summary>
    /// AliApi API: alipay.finance.fund.fund.fixedprofit.query
    /// </summary>
    public class AlipayFinanceFundFundFixedprofitQueryRequest : IAliApiRequest<AlipayFinanceFundFundFixedprofitQueryResponse>
    {
        /// <summary>
        /// 基金定投收益率数据
        /// </summary>
