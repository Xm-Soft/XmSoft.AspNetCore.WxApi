...
{
    /// <summary>
    /// AliApi API: alipay.ins.auto.user.campaign.query
    /// </summary>
    public class AlipayInsAutoUserCampaignQueryRequest : IAliApiRequest<AlipayInsAutoUserCampaignQueryResponse>
    {
        /// <summary>
        /// 获取用户参与活动状态
        /// </summary>
