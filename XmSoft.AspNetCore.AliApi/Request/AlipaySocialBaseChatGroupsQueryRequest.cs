...
{
    /// <summary>
    /// AliApi API: alipay.social.base.chat.groups.query
    /// </summary>
    public class AlipaySocialBaseChatGroupsQueryRequest : IAliApiRequest<AlipaySocialBaseChatGroupsQueryResponse>
    {
        /// <summary>
        /// 支付宝社交查询加入的群列表
        /// </summary>
