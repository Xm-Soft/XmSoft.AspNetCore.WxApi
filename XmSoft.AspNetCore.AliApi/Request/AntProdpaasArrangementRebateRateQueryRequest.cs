...
{
    /// <summary>
    /// AliApi API: ant.prodpaas.arrangement.rebate.rate.query
    /// </summary>
    public class AntProdpaasArrangementRebateRateQueryRequest : IAliApiRequest<AntProdpaasArrangementRebateRateQueryResponse>
    {
        /// <summary>
        /// 签约返点比率查询接口
        /// </summary>
