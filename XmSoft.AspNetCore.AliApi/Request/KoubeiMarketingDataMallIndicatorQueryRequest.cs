...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.mall.indicator.query
    /// </summary>
    public class KoubeiMarketingDataMallIndicatorQueryRequest : IAliApiRequest<KoubeiMarketingDataMallIndicatorQueryResponse>
    {
        /// <summary>
        /// 口碑商户经营数据查询接口
        /// </summary>
