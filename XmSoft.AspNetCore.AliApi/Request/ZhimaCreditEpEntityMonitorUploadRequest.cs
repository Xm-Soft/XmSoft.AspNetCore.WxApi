...
{
    /// <summary>
    /// AliApi API: zhima.credit.ep.entity.monitor.upload
    /// </summary>
    public class ZhimaCreditEpEntityMonitorUploadRequest : IAliApiRequest<ZhimaCreditEpEntityMonitorUploadResponse>
    {
        /// <summary>
        /// 风险雷达上传监控实体列表接口
        /// </summary>
