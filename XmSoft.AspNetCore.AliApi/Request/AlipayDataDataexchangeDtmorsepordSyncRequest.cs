...
{
    /// <summary>
    /// AliApi API: alipay.data.dataexchange.dtmorsepord.sync
    /// </summary>
    public class AlipayDataDataexchangeDtmorsepordSyncRequest : IAliApiRequest<AlipayDataDataexchangeDtmorsepordSyncResponse>
    {
        /// <summary>
        /// 摩斯产品数据反馈接口
        /// </summary>
