...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.member.report.query
    /// </summary>
    public class KoubeiMarketingDataMemberReportQueryRequest : IAliApiRequest<KoubeiMarketingDataMemberReportQueryResponse>
    {
        /// <summary>
        /// 会员报表批量查询接口
        /// </summary>
