...
{
    /// <summary>
    /// AliApi API: alipay.mobile.public.label.user.query
    /// </summary>
    public class AlipayMobilePublicLabelUserQueryRequest : IAliApiRequest<AlipayMobilePublicLabelUserQueryResponse>
    {
        /// <summary>
