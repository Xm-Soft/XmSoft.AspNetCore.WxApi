...
{
    /// <summary>
    /// AliApi API: alipay.ins.cooperation.region.qrcode.apply
    /// </summary>
    public class AlipayInsCooperationRegionQrcodeApplyRequest : IAliApiRequest<AlipayInsCooperationRegionQrcodeApplyResponse>
    {
        /// <summary>
        /// （快捷投保）生成专区二维码
        /// </summary>
