...
{
    /// <summary>
    /// AliApi API: alipay.open.agent.facetoface.sign
    /// </summary>
    public class AlipayOpenAgentFacetofaceSignRequest : IAliApiUploadRequest<AlipayOpenAgentFacetofaceSignResponse>
    {
        /// <summary>
