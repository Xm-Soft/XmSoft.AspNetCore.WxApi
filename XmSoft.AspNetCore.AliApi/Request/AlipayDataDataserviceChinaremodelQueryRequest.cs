...
{
    /// <summary>
    /// AliApi API: alipay.data.dataservice.chinaremodel.query
    /// </summary>
    public class AlipayDataDataserviceChinaremodelQueryRequest : IAliApiRequest<AlipayDataDataserviceChinaremodelQueryResponse>
    {
        /// <summary>
        /// 中再核保结果查询
        /// </summary>
