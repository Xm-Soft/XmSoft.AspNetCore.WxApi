...
{
    /// <summary>
    /// AliApi API: alipay.overseas.travel.content.count.sync
    /// </summary>
    public class AlipayOverseasTravelContentCountSyncRequest : IAliApiRequest<AlipayOverseasTravelContentCountSyncResponse>
    {
        /// <summary>
        /// 飞猪内容对接内容阅读数点赞数同步接口
        /// </summary>
