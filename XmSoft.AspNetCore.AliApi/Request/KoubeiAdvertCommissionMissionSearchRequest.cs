...
{
    /// <summary>
    /// AliApi API: koubei.advert.commission.mission.search
    /// </summary>
    public class KoubeiAdvertCommissionMissionSearchRequest : IAliApiRequest<KoubeiAdvertCommissionMissionSearchResponse>
    {
        /// <summary>
        /// 广告标的分页搜索接口
        /// </summary>
