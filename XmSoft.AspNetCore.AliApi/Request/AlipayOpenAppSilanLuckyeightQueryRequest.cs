...
{
    /// <summary>
    /// AliApi API: alipay.open.app.silan.luckyeight.query
    /// </summary>
    public class AlipayOpenAppSilanLuckyeightQueryRequest : IAliApiRequest<AlipayOpenAppSilanLuckyeightQueryResponse>
    {
