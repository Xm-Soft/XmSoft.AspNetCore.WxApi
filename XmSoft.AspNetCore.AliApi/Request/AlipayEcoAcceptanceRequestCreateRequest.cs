...
{
    /// <summary>
    /// AliApi API: alipay.eco.acceptance.request.create
    /// </summary>
    public class AlipayEcoAcceptanceRequestCreateRequest : IAliApiRequest<AlipayEcoAcceptanceRequestCreateResponse>
    {
        /// <summary>
        /// &#160;云验收进行数据提交
        /// </summary>
