...
{
    /// <summary>
    /// AliApi API: alipay.offline.provider.shopaction.record
    /// </summary>
    public class AlipayOfflineProviderShopactionRecordRequest : IAliApiRequest<AlipayOfflineProviderShopactionRecordResponse>
    {
        /// <summary>
        /// isv 回传的商户操作行为信息调用接口
        /// </summary>
