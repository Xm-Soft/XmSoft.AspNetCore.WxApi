...
{
    /// <summary>
    /// AliApi API: alipay.ins.data.autodamage.estimate.apply
    /// </summary>
    public class AlipayInsDataAutodamageEstimateApplyRequest : IAliApiRequest<AlipayInsDataAutodamageEstimateApplyResponse>
    {
        /// <summary>
        /// 提交车险图像定损请求
        /// </summary>
