...
{
    /// <summary>
    /// AliApi API: alipay.security.risk.policy.rds.query
    /// </summary>
    public class AlipaySecurityRiskPolicyRdsQueryRequest : IAliApiRequest<AlipaySecurityRiskPolicyRdsQueryResponse>
    {
        /// <summary>
