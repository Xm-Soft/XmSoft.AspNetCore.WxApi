...
{
    /// <summary>
    /// AliApi API: alipay.commerce.iot.modellist.create
    /// </summary>
    public class AlipayCommerceIotModellistCreateRequest : IAliApiRequest<AlipayCommerceIotModellistCreateResponse>
    {
        /// <summary>
        /// 设备型号列表创建
        /// </summary>
