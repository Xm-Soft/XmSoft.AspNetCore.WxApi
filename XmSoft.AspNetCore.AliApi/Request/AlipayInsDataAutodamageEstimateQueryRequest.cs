...
{
    /// <summary>
    /// AliApi API: alipay.ins.data.autodamage.estimate.query
    /// </summary>
    public class AlipayInsDataAutodamageEstimateQueryRequest : IAliApiRequest<AlipayInsDataAutodamageEstimateQueryResponse>
    {
        /// <summary>
        /// 查询图像定损结果
        /// </summary>
