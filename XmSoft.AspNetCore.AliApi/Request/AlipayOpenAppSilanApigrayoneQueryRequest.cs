...
{
    /// <summary>
    /// AliApi API: alipay.open.app.silan.apigrayone.query
    /// </summary>
    public class AlipayOpenAppSilanApigrayoneQueryRequest : IAliApiRequest<AlipayOpenAppSilanApigrayoneQueryResponse>
    {
        /// <summary>
        /// 思蓝灰度Zone测试接口one
        /// </summary>
