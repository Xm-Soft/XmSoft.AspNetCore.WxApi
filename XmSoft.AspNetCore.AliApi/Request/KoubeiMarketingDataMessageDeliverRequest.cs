...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.message.deliver
    /// </summary>
    public class KoubeiMarketingDataMessageDeliverRequest : IAliApiRequest<KoubeiMarketingDataMessageDeliverResponse>
    {
        /// <summary>
        /// 一键营销商家中心PUSH消息接口
        /// </summary>
