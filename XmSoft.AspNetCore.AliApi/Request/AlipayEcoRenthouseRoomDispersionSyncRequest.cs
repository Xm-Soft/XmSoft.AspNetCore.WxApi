...
{
    /// <summary>
    /// AliApi API: alipay.eco.renthouse.room.dispersion.sync
    /// </summary>
    public class AlipayEcoRenthouseRoomDispersionSyncRequest : IAliApiRequest<AlipayEcoRenthouseRoomDispersionSyncResponse>
    {
        /// <summary>
        /// 分散式(整租/合租)房源同步
        /// </summary>
