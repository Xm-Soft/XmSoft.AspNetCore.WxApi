...
{
    /// <summary>
    /// AliApi API: alipay.marketing.tool.fengdie.sites.batchquery
    /// </summary>
    public class AlipayMarketingToolFengdieSitesBatchqueryRequest : IAliApiRequest<AlipayMarketingToolFengdieSitesBatchqueryResponse>
    {
        /// <summary>
        /// 获取云凤蝶站点列表
        /// </summary>
