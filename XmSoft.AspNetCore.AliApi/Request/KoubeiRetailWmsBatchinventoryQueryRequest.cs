...
{
    /// <summary>
    /// AliApi API: koubei.retail.wms.batchinventory.query
    /// </summary>
    public class KoubeiRetailWmsBatchinventoryQueryRequest : IAliApiRequest<KoubeiRetailWmsBatchinventoryQueryResponse>
    {
        /// <summary>
        /// 有批次信息的库存查询接口
        /// </summary>
