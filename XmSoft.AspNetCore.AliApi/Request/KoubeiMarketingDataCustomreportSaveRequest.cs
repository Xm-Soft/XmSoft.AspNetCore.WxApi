...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.customreport.save
    /// </summary>
    public class KoubeiMarketingDataCustomreportSaveRequest : IAliApiRequest<KoubeiMarketingDataCustomreportSaveResponse>
    {
        /// <summary>
        /// 自定义数据报表创建及更新接口
        /// </summary>
