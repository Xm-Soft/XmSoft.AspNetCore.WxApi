...
{
    /// <summary>
    /// AliApi API: alipay.marketing.campaign.prize.amount.query
    /// </summary>
    public class AlipayMarketingCampaignPrizeAmountQueryRequest : IAliApiRequest<AlipayMarketingCampaignPrizeAmountQueryResponse>
    {
        /// <summary>
        /// 奖品剩余数量查询
        /// </summary>
