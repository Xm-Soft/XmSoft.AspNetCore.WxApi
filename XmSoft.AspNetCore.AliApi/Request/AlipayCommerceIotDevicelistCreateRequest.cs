...
{
    /// <summary>
    /// AliApi API: alipay.commerce.iot.devicelist.create
    /// </summary>
    public class AlipayCommerceIotDevicelistCreateRequest : IAliApiRequest<AlipayCommerceIotDevicelistCreateResponse>
    {
        /// <summary>
        /// 创建设备记录接口
        /// </summary>
