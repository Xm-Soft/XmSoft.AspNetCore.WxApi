...
{
    /// <summary>
    /// AliApi API: ant.merchant.expand.activity.signup.create
    /// </summary>
    public class AntMerchantExpandActivitySignupCreateRequest : IAliApiRequest<AntMerchantExpandActivitySignupCreateResponse>
    {
        /// <summary>
        /// 活动报名接口
        /// </summary>
