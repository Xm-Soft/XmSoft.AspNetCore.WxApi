...
{
    /// <summary>
    /// AliApi API: alipay.ebpp.industry.kms.pubkey.query
    /// </summary>
    public class AlipayEbppIndustryKmsPubkeyQueryRequest : IAliApiRequest<AlipayEbppIndustryKmsPubkeyQueryResponse>
    {
        /// <summary>
        /// 区块链票据用户公钥查询
        /// </summary>
