...
{
    /// <summary>
    /// AliApi API: alipay.open.public.message.total.send
    /// </summary>
    public class AlipayOpenPublicMessageTotalSendRequest : IAliApiRequest<AlipayOpenPublicMessageTotalSendResponse>
    {
        /// <summary>
