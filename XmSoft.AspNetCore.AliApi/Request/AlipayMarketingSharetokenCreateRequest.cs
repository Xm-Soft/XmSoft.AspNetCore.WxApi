...
{
    /// <summary>
    /// AliApi API: alipay.marketing.sharetoken.create
    /// </summary>
    public class AlipayMarketingSharetokenCreateRequest : IAliApiRequest<AlipayMarketingSharetokenCreateResponse>
    {
        /// <summary>
        /// 支付宝吱口令发放接口
        /// </summary>
