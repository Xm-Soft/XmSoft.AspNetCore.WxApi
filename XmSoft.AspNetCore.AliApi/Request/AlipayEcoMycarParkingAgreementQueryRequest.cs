...
{
    /// <summary>
    /// AliApi API: alipay.eco.mycar.parking.agreement.query
    /// </summary>
    public class AlipayEcoMycarParkingAgreementQueryRequest : IAliApiRequest<AlipayEcoMycarParkingAgreementQueryResponse>
    {
        /// <summary>
        /// 车牌代扣状态查询API
        /// </summary>
