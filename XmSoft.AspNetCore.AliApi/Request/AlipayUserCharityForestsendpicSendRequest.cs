...
{
    /// <summary>
    /// AliApi API: alipay.user.charity.forestsendpic.send
    /// </summary>
    public class AlipayUserCharityForestsendpicSendRequest : IAliApiRequest<AlipayUserCharityForestsendpicSendResponse>
    {
        /// <summary>
        /// 发送蚂蚁森林林区实时图片
        /// </summary>
