...
{
    /// <summary>
    /// AliApi API: alipay.user.antpaas.tokenidentity.query
    /// </summary>
    public class AlipayUserAntpaasTokenidentityQueryRequest : IAliApiRequest<AlipayUserAntpaasTokenidentityQueryResponse>
    {
        /// <summary>
        /// 根据识别因子查询蚂蚁通行证信息
        /// </summary>
