...
{
    /// <summary>
    /// AliApi API: alipay.mobile.public.contact.follow.list
    /// </summary>
    public class AlipayMobilePublicContactFollowListRequest : IAliApiRequest<AlipayMobilePublicContactFollowListResponse>
    {
