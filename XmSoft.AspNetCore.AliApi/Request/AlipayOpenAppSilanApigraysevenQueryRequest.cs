...
{
    /// <summary>
    /// AliApi API: alipay.open.app.silan.apigrayseven.query
    /// </summary>
    public class AlipayOpenAppSilanApigraysevenQueryRequest : IAliApiRequest<AlipayOpenAppSilanApigraysevenQueryResponse>
    {
