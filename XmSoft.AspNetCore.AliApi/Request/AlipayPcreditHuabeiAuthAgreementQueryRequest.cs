...
{
    /// <summary>
    /// AliApi API: alipay.pcredit.huabei.auth.agreement.query
    /// </summary>
    public class AlipayPcreditHuabeiAuthAgreementQueryRequest : IAliApiRequest<AlipayPcreditHuabeiAuthAgreementQueryResponse>
    {
        /// <summary>
        /// 花呗先享协议查询
        /// </summary>
