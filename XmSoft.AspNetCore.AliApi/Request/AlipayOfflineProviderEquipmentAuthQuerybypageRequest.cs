...
{
    /// <summary>
    /// AliApi API: alipay.offline.provider.equipment.auth.querybypage
    /// </summary>
    public class AlipayOfflineProviderEquipmentAuthQuerybypageRequest : IAliApiRequest<AlipayOfflineProviderEquipmentAuthQuerybypageResponse>
    {
        /// <summary>
        /// 解绑查询接口
        /// </summary>
