...
{
    /// <summary>
    /// AliApi API: alipay.mobile.public.menu.user.update
    /// </summary>
    public class AlipayMobilePublicMenuUserUpdateRequest : IAliApiRequest<AlipayMobilePublicMenuUserUpdateResponse>
    {
        /// <summary>
        /// opendId和菜单唯一标识
        /// </summary>
