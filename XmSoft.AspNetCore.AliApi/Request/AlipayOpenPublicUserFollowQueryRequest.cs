...
{
    /// <summary>
    /// AliApi API: alipay.open.public.user.follow.query
    /// </summary>
    public class AlipayOpenPublicUserFollowQueryRequest : IAliApiRequest<AlipayOpenPublicUserFollowQueryResponse>
    {
        /// <summary>
        /// 生活号用户关注查询接口
        /// </summary>
