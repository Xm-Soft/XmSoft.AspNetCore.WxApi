...
{
    /// <summary>
    /// AliApi API: koubei.retail.wms.inventoryrecord.query
    /// </summary>
    public class KoubeiRetailWmsInventoryrecordQueryRequest : IAliApiRequest<KoubeiRetailWmsInventoryrecordQueryResponse>
    {
        /// <summary>
        /// 分页查询库存变更记录
        /// </summary>
