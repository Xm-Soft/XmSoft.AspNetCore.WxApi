...
{
    /// <summary>
    /// AliApi API: alipay.user.account.device.info.query
    /// </summary>
    public class AlipayUserAccountDeviceInfoQueryRequest : IAliApiRequest<AlipayUserAccountDeviceInfoQueryResponse>
    {
        /// <summary>
        /// 查询设备是否支付宝新用户
        /// </summary>
