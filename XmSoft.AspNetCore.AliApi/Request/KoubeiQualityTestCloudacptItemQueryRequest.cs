...
{
    /// <summary>
    /// AliApi API: koubei.quality.test.cloudacpt.item.query
    /// </summary>
    public class KoubeiQualityTestCloudacptItemQueryRequest : IAliApiRequest<KoubeiQualityTestCloudacptItemQueryResponse>
    {
        /// <summary>
        /// 云验收单品列表查询(废弃)
        /// </summary>
