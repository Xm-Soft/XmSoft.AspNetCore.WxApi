...
{
    /// <summary>
    /// AliApi API: alipay.open.app.silin.longnigh.query
    /// </summary>
    public class AlipayOpenAppSilinLongnighQueryRequest : IAliApiRequest<AlipayOpenAppSilinLongnighQueryResponse>
    {
