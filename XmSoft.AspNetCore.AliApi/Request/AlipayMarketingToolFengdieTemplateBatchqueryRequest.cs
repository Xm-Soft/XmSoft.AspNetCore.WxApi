...
{
    /// <summary>
    /// AliApi API: alipay.marketing.tool.fengdie.template.batchquery
    /// </summary>
    public class AlipayMarketingToolFengdieTemplateBatchqueryRequest : IAliApiRequest<AlipayMarketingToolFengdieTemplateBatchqueryResponse>
    {
        /// <summary>
        /// 获取云凤蝶空间可用模板列表
        /// </summary>
