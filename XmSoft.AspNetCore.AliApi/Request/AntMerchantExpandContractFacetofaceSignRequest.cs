...
{
    /// <summary>
    /// AliApi API: ant.merchant.expand.contract.facetoface.sign
    /// </summary>
    public class AntMerchantExpandContractFacetofaceSignRequest : IAliApiRequest<AntMerchantExpandContractFacetofaceSignResponse>
    {
        /// <summary>
        /// 开通当面付申请接口
        /// </summary>
