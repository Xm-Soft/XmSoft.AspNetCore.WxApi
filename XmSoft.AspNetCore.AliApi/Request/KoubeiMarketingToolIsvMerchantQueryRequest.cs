...
{
    /// <summary>
    /// AliApi API: koubei.marketing.tool.isv.merchant.query
    /// </summary>
    public class KoubeiMarketingToolIsvMerchantQueryRequest : IAliApiRequest<KoubeiMarketingToolIsvMerchantQueryResponse>
    {
        /// <summary>
        /// ISV查询商户列表接口
        /// </summary>
