...
{
    /// <summary>
    /// AliApi API: koubei.marketing.tool.mall.points.sync
    /// </summary>
    public class KoubeiMarketingToolMallPointsSyncRequest : IAliApiRequest<KoubeiMarketingToolMallPointsSyncResponse>
    {
        /// <summary>
        /// 口碑商圈集卡数据保存接口
        /// </summary>
