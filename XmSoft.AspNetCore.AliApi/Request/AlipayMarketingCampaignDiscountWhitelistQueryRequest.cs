...
{
    /// <summary>
    /// AliApi API: alipay.marketing.campaign.discount.whitelist.query
    /// </summary>
    public class AlipayMarketingCampaignDiscountWhitelistQueryRequest : IAliApiRequest<AlipayMarketingCampaignDiscountWhitelistQueryResponse>
    {
        /// <summary>
        /// 优惠活动白名单查询
        /// </summary>
