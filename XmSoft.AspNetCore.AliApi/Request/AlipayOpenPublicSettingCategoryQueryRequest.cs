...
{
    /// <summary>
    /// AliApi API: alipay.open.public.setting.category.query
    /// </summary>
    public class AlipayOpenPublicSettingCategoryQueryRequest : IAliApiRequest<AlipayOpenPublicSettingCategoryQueryResponse>
    {
