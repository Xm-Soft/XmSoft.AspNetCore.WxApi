...
{
    /// <summary>
    /// AliApi API: alipay.eco.mycar.parking.config.set
    /// </summary>
    public class AlipayEcoMycarParkingConfigSetRequest : IAliApiRequest<AlipayEcoMycarParkingConfigSetResponse>
    {
        /// <summary>
        /// 停车ISV系统配置接口
        /// </summary>
