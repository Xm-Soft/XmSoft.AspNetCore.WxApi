...
{
    /// <summary>
    /// AliApi API: alipay.ebpp.invoice.list.expense.sync
    /// </summary>
    public class AlipayEbppInvoiceListExpenseSyncRequest : IAliApiRequest<AlipayEbppInvoiceListExpenseSyncResponse>
    {
        /// <summary>
        /// 报销状态批量同步开放接口
        /// </summary>
