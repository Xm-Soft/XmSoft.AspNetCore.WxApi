...
{
    /// <summary>
    /// AliApi API: koubei.marketing.campaign.retail.dm.set
    /// </summary>
    public class KoubeiMarketingCampaignRetailDmSetRequest : IAliApiRequest<KoubeiMarketingCampaignRetailDmSetResponse>
    {
        /// <summary>
        /// 快消店铺展位内容上下架接口
        /// </summary>
