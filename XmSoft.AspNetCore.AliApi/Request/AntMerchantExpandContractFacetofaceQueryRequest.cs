...
{
    /// <summary>
    /// AliApi API: ant.merchant.expand.contract.facetoface.query
    /// </summary>
    public class AntMerchantExpandContractFacetofaceQueryRequest : IAliApiRequest<AntMerchantExpandContractFacetofaceQueryResponse>
    {
        /// <summary>
        /// 当面付申请查询接口
        /// </summary>
