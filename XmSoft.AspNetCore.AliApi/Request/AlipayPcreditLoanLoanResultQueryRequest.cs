...
{
    /// <summary>
    /// AliApi API: alipay.pcredit.loan.loan.result.query
    /// </summary>
    public class AlipayPcreditLoanLoanResultQueryRequest : IAliApiRequest<AlipayPcreditLoanLoanResultQueryResponse>
    {
        /// <summary>
        /// 查询贷款申请结果
        /// </summary>
