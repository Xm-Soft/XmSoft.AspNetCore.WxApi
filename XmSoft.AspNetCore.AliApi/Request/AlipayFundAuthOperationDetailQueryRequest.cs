...
{
    /// <summary>
    /// AliApi API: alipay.fund.auth.operation.detail.query
    /// </summary>
    public class AlipayFundAuthOperationDetailQueryRequest : IAliApiRequest<AlipayFundAuthOperationDetailQueryResponse>
    {
        /// <summary>
        /// 资金预授权单笔操作明细查询接口
        /// </summary>
