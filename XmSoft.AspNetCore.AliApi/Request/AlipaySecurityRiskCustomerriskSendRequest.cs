...
{
    /// <summary>
    /// AliApi API: alipay.security.risk.customerrisk.send
    /// </summary>
    public class AlipaySecurityRiskCustomerriskSendRequest : IAliApiRequest<AlipaySecurityRiskCustomerriskSendResponse>
    {
        /// <summary>
        /// 商户数据同步
        /// </summary>
