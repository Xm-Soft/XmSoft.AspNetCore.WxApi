...
{
    /// <summary>
    /// AliApi API: alipay.open.public.label.user.create
    /// </summary>
    public class AlipayOpenPublicLabelUserCreateRequest : IAliApiRequest<AlipayOpenPublicLabelUserCreateResponse>
    {
        /// <summary>
        /// 用户增加标签接口
        /// </summary>
