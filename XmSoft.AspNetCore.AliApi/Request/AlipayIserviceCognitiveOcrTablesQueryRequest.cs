...
{
    /// <summary>
    /// AliApi API: alipay.iservice.cognitive.ocr.tables.query
    /// </summary>
    public class AlipayIserviceCognitiveOcrTablesQueryRequest : IAliApiRequest<AlipayIserviceCognitiveOcrTablesQueryResponse>
    {
        /// <summary>
        /// 表格类型的图片信息抽取服务
        /// </summary>
