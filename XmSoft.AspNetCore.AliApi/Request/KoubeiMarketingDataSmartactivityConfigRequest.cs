...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.smartactivity.config
    /// </summary>
    public class KoubeiMarketingDataSmartactivityConfigRequest : IAliApiRequest<KoubeiMarketingDataSmartactivityConfigResponse>
    {
        /// <summary>
        /// 商户智能活动配置方案接口
        /// </summary>
