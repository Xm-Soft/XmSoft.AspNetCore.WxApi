...
{
    /// <summary>
    /// AliApi API: zhima.merchant.activity.batchquery
    /// </summary>
    public class ZhimaMerchantActivityBatchqueryRequest : IAliApiRequest<ZhimaMerchantActivityBatchqueryResponse>
    {
        /// <summary>
        /// 信用承诺消费活动分页查询接口
        /// </summary>
