...
{
    /// <summary>
    /// AliApi API: alipay.open.public.life.account.create
    /// </summary>
    public class AlipayOpenPublicLifeAccountCreateRequest : IAliApiUploadRequest<AlipayOpenPublicLifeAccountCreateResponse>
    {
        /// <summary>
