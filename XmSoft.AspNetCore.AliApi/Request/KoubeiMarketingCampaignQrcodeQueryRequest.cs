...
{
    /// <summary>
    /// AliApi API: koubei.marketing.campaign.qrcode.query
    /// </summary>
    public class KoubeiMarketingCampaignQrcodeQueryRequest : IAliApiRequest<KoubeiMarketingCampaignQrcodeQueryResponse>
    {
        /// <summary>
        /// 口碑活动二维码查询接口
        /// </summary>
