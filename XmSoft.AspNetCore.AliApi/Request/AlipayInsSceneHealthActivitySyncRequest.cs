...
{
    /// <summary>
    /// AliApi API: alipay.ins.scene.health.activity.sync
    /// </summary>
    public class AlipayInsSceneHealthActivitySyncRequest : IAliApiRequest<AlipayInsSceneHealthActivitySyncResponse>
    {
        /// <summary>
        /// 机构同步健康检测产品信息
        /// </summary>
