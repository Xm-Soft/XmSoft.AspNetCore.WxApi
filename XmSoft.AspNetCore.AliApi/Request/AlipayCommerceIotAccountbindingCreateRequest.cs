...
{
    /// <summary>
    /// AliApi API: alipay.commerce.iot.accountbinding.create
    /// </summary>
    public class AlipayCommerceIotAccountbindingCreateRequest : IAliApiRequest<AlipayCommerceIotAccountbindingCreateResponse>
    {
        /// <summary>
        /// 用户账号绑定关系创建
        /// </summary>
