...
{
    /// <summary>
    /// AliApi API: alipay.eco.mycar.violation.vehicle.query
    /// </summary>
    public class AlipayEcoMycarViolationVehicleQueryRequest : IAliApiRequest<AlipayEcoMycarViolationVehicleQueryResponse>
    {
        /// <summary>
        /// ISV获取用户违章车辆信息
        /// </summary>
