...
{
    /// <summary>
    /// AliApi API: alipay.open.public.multimedia.download.proxy
    /// </summary>
    public class AlipayOpenPublicMultimediaDownloadProxyRequest : IAliApiRequest<AlipayOpenPublicMultimediaDownloadProxyResponse>
    {
