...
{
    /// <summary>
    /// AliApi API: alipay.security.prod.deviceinfo.query
    /// </summary>
    public class AlipaySecurityProdDeviceinfoQueryRequest : IAliApiRequest<AlipaySecurityProdDeviceinfoQueryResponse>
    {
        /// <summary>
        /// 根据tokenID查询设备数据字段
        /// </summary>
