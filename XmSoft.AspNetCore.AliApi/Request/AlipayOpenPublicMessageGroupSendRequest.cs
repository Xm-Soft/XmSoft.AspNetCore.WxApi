...
{
    /// <summary>
    /// AliApi API: alipay.open.public.message.group.send
    /// </summary>
    public class AlipayOpenPublicMessageGroupSendRequest : IAliApiRequest<AlipayOpenPublicMessageGroupSendResponse>
    {
        /// <summary>
        /// 分组消息发送接口
        /// </summary>
