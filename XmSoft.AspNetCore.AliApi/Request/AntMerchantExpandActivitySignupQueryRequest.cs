...
{
    /// <summary>
    /// AliApi API: ant.merchant.expand.activity.signup.query
    /// </summary>
    public class AntMerchantExpandActivitySignupQueryRequest : IAliApiRequest<AntMerchantExpandActivitySignupQueryResponse>
    {
        /// <summary>
        /// 活动报名查询接口
        /// </summary>
