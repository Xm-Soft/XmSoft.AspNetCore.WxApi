...
{
    /// <summary>
    /// AliApi API: alipay.open.public.topic.batchquery
    /// </summary>
    public class AlipayOpenPublicTopicBatchqueryRequest : IAliApiRequest<AlipayOpenPublicTopicBatchqueryResponse>
    {
