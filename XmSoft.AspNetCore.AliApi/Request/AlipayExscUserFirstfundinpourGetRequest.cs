...
{
    /// <summary>
    /// AliApi API: alipay.exsc.user.firstfundinpour.get
    /// </summary>
    public class AlipayExscUserFirstfundinpourGetRequest : IAliApiRequest<AlipayExscUserFirstfundinpourGetResponse>
    {
        /// <summary>
