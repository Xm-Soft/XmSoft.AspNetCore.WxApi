...
{
    /// <summary>
    /// AliApi API: alipay.eco.renthouse.bill.order.download
    /// </summary>
    public class AlipayEcoRenthouseBillOrderDownloadRequest : IAliApiRequest<AlipayEcoRenthouseBillOrderDownloadResponse>
    {
        /// <summary>
        /// 商户对账文件下载
        /// </summary>
