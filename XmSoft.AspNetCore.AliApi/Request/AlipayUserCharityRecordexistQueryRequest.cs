...
{
    /// <summary>
    /// AliApi API: alipay.user.charity.recordexist.query
    /// </summary>
    public class AlipayUserCharityRecordexistQueryRequest : IAliApiRequest<AlipayUserCharityRecordexistQueryResponse>
    {
        /// <summary>
        /// 查询是否在支付宝公益捐赠的接口
        /// </summary>
