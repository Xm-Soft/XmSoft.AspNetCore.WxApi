...
{
    /// <summary>
    /// AliApi API: alipay.ins.scene.application.batchquery
    /// </summary>
    public class AlipayInsSceneApplicationBatchqueryRequest : IAliApiRequest<AlipayInsSceneApplicationBatchqueryResponse>
    {
        /// <summary>
        /// 投保单列表查询
        /// </summary>
