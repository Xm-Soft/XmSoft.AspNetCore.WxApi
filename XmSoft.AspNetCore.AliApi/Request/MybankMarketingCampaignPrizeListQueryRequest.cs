...
{
    /// <summary>
    /// AliApi API: mybank.marketing.campaign.prize.list.query
    /// </summary>
    public class MybankMarketingCampaignPrizeListQueryRequest : IAliApiRequest<MybankMarketingCampaignPrizeListQueryResponse>
    {
        /// <summary>
        /// 查询用户已拥有的奖品列表
        /// </summary>
