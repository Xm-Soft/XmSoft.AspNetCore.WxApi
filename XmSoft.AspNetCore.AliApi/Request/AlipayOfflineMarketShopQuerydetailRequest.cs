...
{
    /// <summary>
    /// AliApi API: alipay.offline.market.shop.querydetail
    /// </summary>
    public class AlipayOfflineMarketShopQuerydetailRequest : IAliApiRequest<AlipayOfflineMarketShopQuerydetailResponse>
    {
        /// <summary>
