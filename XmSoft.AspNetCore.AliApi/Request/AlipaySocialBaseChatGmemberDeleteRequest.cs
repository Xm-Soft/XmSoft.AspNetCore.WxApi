...
{
    /// <summary>
    /// AliApi API: alipay.social.base.chat.gmember.delete
    /// </summary>
    public class AlipaySocialBaseChatGmemberDeleteRequest : IAliApiRequest<AlipaySocialBaseChatGmemberDeleteResponse>
    {
        /// <summary>
        /// 支付宝社交剔除群成员
        /// </summary>
