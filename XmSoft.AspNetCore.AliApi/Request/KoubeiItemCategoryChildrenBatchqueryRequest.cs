...
{
    /// <summary>
    /// AliApi API: koubei.item.category.children.batchquery
    /// </summary>
    public class KoubeiItemCategoryChildrenBatchqueryRequest : IAliApiRequest<KoubeiItemCategoryChildrenBatchqueryResponse>
    {
        /// <summary>
        /// 批量查询标准后台类目
        /// </summary>
