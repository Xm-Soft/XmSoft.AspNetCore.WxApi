...
{
    /// <summary>
    /// AliApi API: mybank.credit.creditrisk.widget.query
    /// </summary>
    public class MybankCreditCreditriskWidgetQueryRequest : IAliApiRequest<MybankCreditCreditriskWidgetQueryResponse>
    {
        /// <summary>
        /// 查询千牛网商有数widget的数据
        /// </summary>
