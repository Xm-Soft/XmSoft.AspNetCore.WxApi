...
{
    /// <summary>
    /// AliApi API: alipay.overseas.travel.rate.batchquery
    /// </summary>
    public class AlipayOverseasTravelRateBatchqueryRequest : IAliApiRequest<AlipayOverseasTravelRateBatchqueryResponse>
    {
        /// <summary>
        /// 跨境游汇率批量查询接口
        /// </summary>
