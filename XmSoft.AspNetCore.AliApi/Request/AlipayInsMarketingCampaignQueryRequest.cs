...
{
    /// <summary>
    /// AliApi API: alipay.ins.marketing.campaign.query
    /// </summary>
    public class AlipayInsMarketingCampaignQueryRequest : IAliApiRequest<AlipayInsMarketingCampaignQueryResponse>
    {
        /// <summary>
        /// 根据活动id查询活动信息
        /// </summary>
