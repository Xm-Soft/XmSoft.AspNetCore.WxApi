...
{
    /// <summary>
    /// AliApi API: alipay.open.public.message.label.send
    /// </summary>
    public class AlipayOpenPublicMessageLabelSendRequest : IAliApiRequest<AlipayOpenPublicMessageLabelSendResponse>
    {
        /// <summary>
        /// 根据标签组发消息接口
        /// </summary>
