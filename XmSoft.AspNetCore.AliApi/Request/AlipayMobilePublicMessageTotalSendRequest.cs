...
{
    /// <summary>
    /// AliApi API: alipay.mobile.public.message.total.send
    /// </summary>
    public class AlipayMobilePublicMessageTotalSendRequest : IAliApiRequest<AlipayMobilePublicMessageTotalSendResponse>
    {
        /// <summary>
