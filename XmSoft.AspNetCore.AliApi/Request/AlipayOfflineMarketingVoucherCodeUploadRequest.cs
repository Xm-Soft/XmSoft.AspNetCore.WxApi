...
{
    /// <summary>
    /// AliApi API: alipay.offline.marketing.voucher.code.upload
    /// </summary>
    public class AlipayOfflineMarketingVoucherCodeUploadRequest : IAliApiUploadRequest<AlipayOfflineMarketingVoucherCodeUploadResponse>
    {
        /// <summary>
        /// 约定的扩展参数
        /// </summary>
