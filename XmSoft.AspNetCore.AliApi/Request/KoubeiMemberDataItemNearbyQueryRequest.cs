...
{
    /// <summary>
    /// AliApi API: koubei.member.data.item.nearby.query
    /// </summary>
    public class KoubeiMemberDataItemNearbyQueryRequest : IAliApiRequest<KoubeiMemberDataItemNearbyQueryResponse>
    {
        /// <summary>
        /// 查询附近优惠商品信息
        /// </summary>
