...
{
    /// <summary>
    /// AliApi API: alipay.open.app.silan.apigrayeleven.query
    /// </summary>
    public class AlipayOpenAppSilanApigrayelevenQueryRequest : IAliApiRequest<AlipayOpenAppSilanApigrayelevenQueryResponse>
    {
