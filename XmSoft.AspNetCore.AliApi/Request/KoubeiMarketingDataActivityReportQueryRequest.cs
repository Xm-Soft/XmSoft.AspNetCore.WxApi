...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.activity.report.query
    /// </summary>
    public class KoubeiMarketingDataActivityReportQueryRequest : IAliApiRequest<KoubeiMarketingDataActivityReportQueryResponse>
    {
        /// <summary>
        /// 口碑商户营销报表查询
        /// </summary>
