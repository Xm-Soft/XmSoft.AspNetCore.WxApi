...
{
    /// <summary>
    /// AliApi API: alipay.user.stepcounter.data.batchquery
    /// </summary>
    public class AlipayUserStepcounterDataBatchqueryRequest : IAliApiRequest<AlipayUserStepcounterDataBatchqueryResponse>
    {
        /// <summary>
        /// 支付宝用户日计步数据批量查询接口
        /// </summary>
