...
{
    /// <summary>
    /// AliApi API: alipay.ebpp.jfexport.inputfield.query
    /// </summary>
    public class AlipayEbppJfexportInputfieldQueryRequest : IAliApiRequest<AlipayEbppJfexportInputfieldQueryResponse>
    {
        /// <summary>
        /// 查询缴费输出的出账机构输入域
        /// </summary>
