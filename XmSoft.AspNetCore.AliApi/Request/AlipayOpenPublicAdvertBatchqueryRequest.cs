...
{
    /// <summary>
    /// AliApi API: alipay.open.public.advert.batchquery
    /// </summary>
    public class AlipayOpenPublicAdvertBatchqueryRequest : IAliApiRequest<AlipayOpenPublicAdvertBatchqueryResponse>
    {
