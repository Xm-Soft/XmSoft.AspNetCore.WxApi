...
{
    /// <summary>
    /// AliApi API: alipay.security.risk.content.result.get
    /// </summary>
    public class AlipaySecurityRiskContentResultGetRequest : IAliApiRequest<AlipaySecurityRiskContentResultGetResponse>
    {
        /// <summary>
        /// 内容风险识别结果查询接口服务
        /// </summary>
