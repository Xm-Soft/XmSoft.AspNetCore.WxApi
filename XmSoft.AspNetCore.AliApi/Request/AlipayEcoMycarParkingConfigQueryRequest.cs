...
{
    /// <summary>
    /// AliApi API: alipay.eco.mycar.parking.config.query
    /// </summary>
    public class AlipayEcoMycarParkingConfigQueryRequest : IAliApiRequest<AlipayEcoMycarParkingConfigQueryResponse>
    {
        /// <summary>
        /// ISV系统配置查询接口
        /// </summary>
