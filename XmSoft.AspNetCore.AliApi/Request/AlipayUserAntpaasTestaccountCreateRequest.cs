...
{
    /// <summary>
    /// AliApi API: alipay.user.antpaas.testaccount.create
    /// </summary>
    public class AlipayUserAntpaasTestaccountCreateRequest : IAliApiRequest<AlipayUserAntpaasTestaccountCreateResponse>
    {
        /// <summary>
        /// 创建测试支付宝账户
        /// </summary>
