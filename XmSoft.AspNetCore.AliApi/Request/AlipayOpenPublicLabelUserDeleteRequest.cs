...
{
    /// <summary>
    /// AliApi API: alipay.open.public.label.user.delete
    /// </summary>
    public class AlipayOpenPublicLabelUserDeleteRequest : IAliApiRequest<AlipayOpenPublicLabelUserDeleteResponse>
    {
        /// <summary>
        /// 公众号标签管理-删除用户标签
        /// </summary>
