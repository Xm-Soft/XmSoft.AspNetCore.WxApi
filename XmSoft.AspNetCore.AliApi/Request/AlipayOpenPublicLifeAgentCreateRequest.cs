...
{
    /// <summary>
    /// AliApi API: alipay.open.public.life.agent.create
    /// </summary>
    public class AlipayOpenPublicLifeAgentCreateRequest : IAliApiUploadRequest<AlipayOpenPublicLifeAgentCreateResponse>
    {
        /// <summary>
