...
{
    /// <summary>
    /// AliApi API: alipay.marketing.cdp.advertise.create
    /// </summary>
    public class AlipayMarketingCdpAdvertiseCreateRequest : IAliApiRequest<AlipayMarketingCdpAdvertiseCreateResponse>
    {
        /// <summary>
