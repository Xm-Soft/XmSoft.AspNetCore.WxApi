...
{
    /// <summary>
    /// AliApi API: alipay.pcredit.loan.loan.info.query
    /// </summary>
    public class AlipayPcreditLoanLoanInfoQueryRequest : IAliApiRequest<AlipayPcreditLoanLoanInfoQueryResponse>
    {
        /// <summary>
        /// 查询贷款记录信息
        /// </summary>
