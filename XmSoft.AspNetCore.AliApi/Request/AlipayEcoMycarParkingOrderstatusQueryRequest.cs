...
{
    /// <summary>
    /// AliApi API: alipay.eco.mycar.parking.orderstatus.query
    /// </summary>
    public class AlipayEcoMycarParkingOrderstatusQueryRequest : IAliApiRequest<AlipayEcoMycarParkingOrderstatusQueryResponse>
    {
        /// <summary>
        /// 订单状态查询接口
        /// </summary>
