...
{
    /// <summary>
    /// AliApi API: alipay.security.risk.riskscan.single.query
    /// </summary>
    public class AlipaySecurityRiskRiskscanSingleQueryRequest : IAliApiRequest<AlipaySecurityRiskRiskscanSingleQueryResponse>
    {
        /// <summary>
        /// 蚂蚁金服信息安全平台风险扫描接口
        /// </summary>
