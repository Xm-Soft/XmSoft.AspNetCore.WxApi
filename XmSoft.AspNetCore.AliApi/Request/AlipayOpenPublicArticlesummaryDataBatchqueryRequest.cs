...
{
    /// <summary>
    /// AliApi API: alipay.open.public.articlesummary.data.batchquery
    /// </summary>
    public class AlipayOpenPublicArticlesummaryDataBatchqueryRequest : IAliApiRequest<AlipayOpenPublicArticlesummaryDataBatchqueryResponse>
    {
        /// <summary>
        /// 图文分析-按时间查询数据接口
        /// </summary>
