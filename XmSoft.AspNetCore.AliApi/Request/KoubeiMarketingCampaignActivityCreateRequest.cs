...
{
    /// <summary>
    /// AliApi API: koubei.marketing.campaign.activity.create
    /// </summary>
    public class KoubeiMarketingCampaignActivityCreateRequest : IAliApiRequest<KoubeiMarketingCampaignActivityCreateResponse>
    {
        /// <summary>
        /// 活动创建接口
        /// </summary>
