...
{
    /// <summary>
    /// AliApi API: alipay.open.public.user.data.batchquery
    /// </summary>
    public class AlipayOpenPublicUserDataBatchqueryRequest : IAliApiRequest<AlipayOpenPublicUserDataBatchqueryResponse>
    {
        /// <summary>
        /// 用户分析数据查询接口
        /// </summary>
