...
{
    /// <summary>
    /// AliApi API: alipay.open.public.message.content.modify
    /// </summary>
    public class AlipayOpenPublicMessageContentModifyRequest : IAliApiRequest<AlipayOpenPublicMessageContentModifyResponse>
    {
        /// <summary>
        /// 修改图文消息素材接口
        /// </summary>
