...
{
    /// <summary>
    /// AliApi API: alipay.open.public.life.agentcreate.query
    /// </summary>
    public class AlipayOpenPublicLifeAgentcreateQueryRequest : IAliApiRequest<AlipayOpenPublicLifeAgentcreateQueryResponse>
    {
        /// <summary>
        /// isv代创建生活号申请状态查询接口
        /// </summary>
