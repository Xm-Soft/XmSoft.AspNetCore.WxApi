...
{
    /// <summary>
    /// AliApi API: alipay.marketing.data.deer.connector.query
    /// </summary>
    public class AlipayMarketingDataDeerConnectorQueryRequest : IAliApiRequest<AlipayMarketingDataDeerConnectorQueryResponse>
    {
        /// <summary>
        /// 获取 H5 活动洞察数据
        /// </summary>
