...
{
    /// <summary>
    /// AliApi API: alipay.user.antpaas.addtesttag.modify
    /// </summary>
    public class AlipayUserAntpaasAddtesttagModifyRequest : IAliApiRequest<AlipayUserAntpaasAddtesttagModifyResponse>
    {
        /// <summary>
        /// 给支付宝账户打测试账号标记
        /// </summary>
