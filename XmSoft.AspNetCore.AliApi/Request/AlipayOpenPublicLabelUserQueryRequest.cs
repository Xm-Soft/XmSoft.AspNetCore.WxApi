...
{
    /// <summary>
    /// AliApi API: alipay.open.public.label.user.query
    /// </summary>
    public class AlipayOpenPublicLabelUserQueryRequest : IAliApiRequest<AlipayOpenPublicLabelUserQueryResponse>
    {
        /// <summary>
        /// 公众号标签管理-查询用户标签
        /// </summary>
