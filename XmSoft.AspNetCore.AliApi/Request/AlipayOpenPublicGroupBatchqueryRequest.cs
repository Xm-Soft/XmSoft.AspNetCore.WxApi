...
{
    /// <summary>
    /// AliApi API: alipay.open.public.group.batchquery
    /// </summary>
    public class AlipayOpenPublicGroupBatchqueryRequest : IAliApiRequest<AlipayOpenPublicGroupBatchqueryResponse>
    {
