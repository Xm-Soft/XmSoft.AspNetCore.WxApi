...
{
    /// <summary>
    /// AliApi API: alipay.open.app.yilingersiyufa.query
    /// </summary>
    public class AlipayOpenAppYilingersiyufaQueryRequest : IAliApiRequest<AlipayOpenAppYilingersiyufaQueryResponse>
    {
