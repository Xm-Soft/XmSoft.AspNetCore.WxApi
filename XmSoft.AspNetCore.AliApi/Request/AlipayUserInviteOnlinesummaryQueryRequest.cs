...
{
    /// <summary>
    /// AliApi API: alipay.user.invite.onlinesummary.query
    /// </summary>
    public class AlipayUserInviteOnlinesummaryQueryRequest : IAliApiRequest<AlipayUserInviteOnlinesummaryQueryResponse>
    {
        /// <summary>
        /// 线上拉新结算汇总数据查询
        /// </summary>
