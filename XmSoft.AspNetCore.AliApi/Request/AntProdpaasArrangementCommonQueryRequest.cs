...
{
    /// <summary>
    /// AliApi API: ant.prodpaas.arrangement.common.query
    /// </summary>
    public class AntProdpaasArrangementCommonQueryRequest : IAliApiRequest<AntProdpaasArrangementCommonQueryResponse>
    {
        /// <summary>
        /// 合约通用查询接口
        /// </summary>
