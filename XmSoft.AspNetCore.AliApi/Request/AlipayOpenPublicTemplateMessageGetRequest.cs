...
{
    /// <summary>
    /// AliApi API: alipay.open.public.template.message.get
    /// </summary>
    public class AlipayOpenPublicTemplateMessageGetRequest : IAliApiRequest<AlipayOpenPublicTemplateMessageGetResponse>
    {
        /// <summary>
        /// 模板消息领取接口
        /// </summary>
