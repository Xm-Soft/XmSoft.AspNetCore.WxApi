...
{
    /// <summary>
    /// AliApi API: alipay.fund.trans.batch.createorder
    /// </summary>
    public class AlipayFundTransBatchCreateorderRequest : IAliApiRequest<AlipayFundTransBatchCreateorderResponse>
    {
        /// <summary>
