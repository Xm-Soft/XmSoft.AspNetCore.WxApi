...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.mall.discount.query
    /// </summary>
    public class KoubeiMarketingDataMallDiscountQueryRequest : IAliApiRequest<KoubeiMarketingDataMallDiscountQueryResponse>
    {
        /// <summary>
        /// 用户已获得的优惠信息查询接口
        /// </summary>
