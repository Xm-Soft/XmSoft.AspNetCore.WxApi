...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.alisis.report.query
    /// </summary>
    public class KoubeiMarketingDataAlisisReportQueryRequest : IAliApiRequest<KoubeiMarketingDataAlisisReportQueryResponse>
    {
        /// <summary>
        /// 报表详情查询接口
        /// </summary>
