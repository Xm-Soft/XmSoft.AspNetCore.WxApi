...
{
    /// <summary>
    /// AliApi API: alipay.eco.edu.kt.schoolinfo.modify
    /// </summary>
    public class AlipayEcoEduKtSchoolinfoModifyRequest : IAliApiRequest<AlipayEcoEduKtSchoolinfoModifyResponse>
    {
        /// <summary>
        /// 教育缴费学校信息录入接口
        /// </summary>
