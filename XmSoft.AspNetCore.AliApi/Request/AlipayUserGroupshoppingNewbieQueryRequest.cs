...
{
    /// <summary>
    /// AliApi API: alipay.user.groupshopping.newbie.query
    /// </summary>
    public class AlipayUserGroupshoppingNewbieQueryRequest : IAliApiRequest<AlipayUserGroupshoppingNewbieQueryResponse>
    {
        /// <summary>
        /// 支付宝拼团查询是否有一元拼资格
        /// </summary>
