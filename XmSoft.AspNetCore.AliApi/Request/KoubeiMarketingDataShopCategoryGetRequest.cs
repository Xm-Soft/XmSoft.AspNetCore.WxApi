...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.shop.category.get
    /// </summary>
    public class KoubeiMarketingDataShopCategoryGetRequest : IAliApiRequest<KoubeiMarketingDataShopCategoryGetResponse>
    {
        /// <summary>
        /// 获取商圈店铺分类
        /// </summary>
