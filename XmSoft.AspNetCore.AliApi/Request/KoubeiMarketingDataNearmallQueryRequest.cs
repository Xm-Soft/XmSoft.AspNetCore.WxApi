...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.nearmall.query
    /// </summary>
    public class KoubeiMarketingDataNearmallQueryRequest : IAliApiRequest<KoubeiMarketingDataNearmallQueryResponse>
    {
        /// <summary>
        /// 周边商圈查询
        /// </summary>
