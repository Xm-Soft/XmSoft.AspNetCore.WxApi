...
{
    /// <summary>
    /// AliApi API: alipay.iservice.mindv.jobsbyuser.query
    /// </summary>
    public class AlipayIserviceMindvJobsbyuserQueryRequest : IAliApiRequest<AlipayIserviceMindvJobsbyuserQueryResponse>
    {
        /// <summary>
        /// 小蚁触角_查询用户作答过的任务
        /// </summary>
