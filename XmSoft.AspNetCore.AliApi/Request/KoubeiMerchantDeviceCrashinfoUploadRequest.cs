...
{
    /// <summary>
    /// AliApi API: koubei.merchant.device.crashinfo.upload
    /// </summary>
    public class KoubeiMerchantDeviceCrashinfoUploadRequest : IAliApiRequest<KoubeiMerchantDeviceCrashinfoUploadResponse>
    {
        /// <summary>
        /// crash 信息上报接口
        /// </summary>
