...
{
    /// <summary>
    /// AliApi API: alipay.open.servicemarket.order.query
    /// </summary>
    public class AlipayOpenServicemarketOrderQueryRequest : IAliApiRequest<AlipayOpenServicemarketOrderQueryResponse>
    {
        /// <summary>
        /// 用于服务商回查服务市场订单明细信息
        /// </summary>
