...
{
    /// <summary>
    /// AliApi API: mybank.credit.loanapply.insturl.query
    /// </summary>
    public class MybankCreditLoanapplyInsturlQueryRequest : IAliApiRequest<MybankCreditLoanapplyInsturlQueryResponse>
    {
        /// <summary>
        /// 机构跳转链接查询接口
        /// </summary>
