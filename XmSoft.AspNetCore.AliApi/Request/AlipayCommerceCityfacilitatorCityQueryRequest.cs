...
{
    /// <summary>
    /// AliApi API: alipay.commerce.cityfacilitator.city.query
    /// </summary>
    public class AlipayCommerceCityfacilitatorCityQueryRequest : IAliApiRequest<AlipayCommerceCityfacilitatorCityQueryResponse>
    {
