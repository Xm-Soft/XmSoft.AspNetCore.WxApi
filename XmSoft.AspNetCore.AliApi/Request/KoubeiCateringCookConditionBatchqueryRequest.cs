...
{
    /// <summary>
    /// AliApi API: koubei.catering.cook.condition.batchquery
    /// </summary>
    public class KoubeiCateringCookConditionBatchqueryRequest : IAliApiRequest<KoubeiCateringCookConditionBatchqueryResponse>
    {
        /// <summary>
        /// 根据商户店铺批量查询菜谱
        /// </summary>
