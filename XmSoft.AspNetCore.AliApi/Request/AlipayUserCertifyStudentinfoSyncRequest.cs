...
{
    /// <summary>
    /// AliApi API: alipay.user.certify.studentinfo.sync
    /// </summary>
    public class AlipayUserCertifyStudentinfoSyncRequest : IAliApiRequest<AlipayUserCertifyStudentinfoSyncResponse>
    {
        /// <summary>
        /// 同步学生认证数据
        /// </summary>
