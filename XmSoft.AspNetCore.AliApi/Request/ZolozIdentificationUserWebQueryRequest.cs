...
{
    /// <summary>
    /// AliApi API: zoloz.identification.user.web.query
    /// </summary>
    public class ZolozIdentificationUserWebQueryRequest : IAliApiRequest<ZolozIdentificationUserWebQueryResponse>
    {
        /// <summary>
        /// H5刷脸认证查询
        /// </summary>
