...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.mall.check.get
    /// </summary>
    public class KoubeiMarketingDataMallCheckGetRequest : IAliApiRequest<KoubeiMarketingDataMallCheckGetResponse>
    {
        /// <summary>
        /// 商圈圈子用户产生数据安全校验
        /// </summary>
