...
{
    /// <summary>
    /// AliApi API: mybank.credit.loantrade.loanscheme.query
    /// </summary>
    public class MybankCreditLoantradeLoanschemeQueryRequest : IAliApiRequest<MybankCreditLoantradeLoanschemeQueryResponse>
    {
        /// <summary>
        /// 外部商业平台合作-查询可贷款方案
        /// </summary>
