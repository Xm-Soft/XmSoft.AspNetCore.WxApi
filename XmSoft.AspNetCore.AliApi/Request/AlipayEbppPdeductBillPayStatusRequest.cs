...
{
    /// <summary>
    /// AliApi API: alipay.ebpp.pdeduct.bill.pay.status
    /// </summary>
    public class AlipayEbppPdeductBillPayStatusRequest : IAliApiRequest<AlipayEbppPdeductBillPayStatusResponse>
    {
        /// <summary>
        /// 支付宝用户ID
        /// </summary>
