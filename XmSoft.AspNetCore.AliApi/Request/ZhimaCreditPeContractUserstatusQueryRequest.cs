...
{
    /// <summary>
    /// AliApi API: zhima.credit.pe.contract.userstatus.query
    /// </summary>
    public class ZhimaCreditPeContractUserstatusQueryRequest : IAliApiRequest<ZhimaCreditPeContractUserstatusQueryResponse>
    {
        /// <summary>
        /// 用户签约状态查询
        /// </summary>
