...
{
    /// <summary>
    /// AliApi API: alipay.eco.mycar.violation.city.push
    /// </summary>
    public class AlipayEcoMycarViolationCityPushRequest : IAliApiRequest<AlipayEcoMycarViolationCityPushResponse>
    {
        /// <summary>
        /// 推送新支持违章查询的城市
        /// </summary>
