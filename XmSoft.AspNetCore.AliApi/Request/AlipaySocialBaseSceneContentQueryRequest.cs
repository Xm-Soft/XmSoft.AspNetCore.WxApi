...
{
    /// <summary>
    /// AliApi API: alipay.social.base.scene.content.query
    /// </summary>
    public class AlipaySocialBaseSceneContentQueryRequest : IAliApiRequest<AlipaySocialBaseSceneContentQueryResponse>
    {
        /// <summary>
        /// 查询场景下内容列表信息
        /// </summary>
