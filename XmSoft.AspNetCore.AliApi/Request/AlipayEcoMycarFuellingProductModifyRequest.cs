...
{
    /// <summary>
    /// AliApi API: alipay.eco.mycar.fuelling.product.modify
    /// </summary>
    public class AlipayEcoMycarFuellingProductModifyRequest : IAliApiRequest<AlipayEcoMycarFuellingProductModifyResponse>
    {
        /// <summary>
        /// 加油站门店商品营销信息设置接口
        /// </summary>
