...
{
    /// <summary>
    /// AliApi API: alipay.commerce.medical.instcard.bind
    /// </summary>
    public class AlipayCommerceMedicalInstcardBindRequest : IAliApiRequest<AlipayCommerceMedicalInstcardBindResponse>
    {
        /// <summary>
