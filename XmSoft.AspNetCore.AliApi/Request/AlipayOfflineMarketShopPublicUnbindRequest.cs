...
{
    /// <summary>
    /// AliApi API: alipay.offline.market.shop.public.unbind
    /// </summary>
    public class AlipayOfflineMarketShopPublicUnbindRequest : IAliApiRequest<AlipayOfflineMarketShopPublicUnbindResponse>
    {
        /// <summary>
