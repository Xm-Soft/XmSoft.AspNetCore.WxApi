...
{
    /// <summary>
    /// AliApi API: koubei.advert.commission.bill.query
    /// </summary>
    public class KoubeiAdvertCommissionBillQueryRequest : IAliApiRequest<KoubeiAdvertCommissionBillQueryResponse>
    {
        /// <summary>
        /// 口碑客分佣账单查询接口
        /// </summary>
