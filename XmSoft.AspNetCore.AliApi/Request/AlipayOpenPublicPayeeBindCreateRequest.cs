...
{
    /// <summary>
    /// AliApi API: alipay.open.public.payee.bind.create
    /// </summary>
    public class AlipayOpenPublicPayeeBindCreateRequest : IAliApiRequest<AlipayOpenPublicPayeeBindCreateResponse>
    {
        /// <summary>
        /// 添加收款账号接口
        /// </summary>
