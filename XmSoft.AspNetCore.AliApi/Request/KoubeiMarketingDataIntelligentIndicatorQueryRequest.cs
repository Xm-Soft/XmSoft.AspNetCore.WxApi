...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.intelligent.indicator.query
    /// </summary>
    public class KoubeiMarketingDataIntelligentIndicatorQueryRequest : IAliApiRequest<KoubeiMarketingDataIntelligentIndicatorQueryResponse>
    {
        /// <summary>
        /// 智能营销方案维度的数据查询
        /// </summary>
