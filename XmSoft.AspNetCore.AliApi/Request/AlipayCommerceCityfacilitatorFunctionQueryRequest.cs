...
{
    /// <summary>
    /// AliApi API: alipay.commerce.cityfacilitator.function.query
    /// </summary>
    public class AlipayCommerceCityfacilitatorFunctionQueryRequest : IAliApiRequest<AlipayCommerceCityfacilitatorFunctionQueryResponse>
    {
        /// <summary>
        /// 基于设备和城市查询当前支持的功能
        /// </summary>
