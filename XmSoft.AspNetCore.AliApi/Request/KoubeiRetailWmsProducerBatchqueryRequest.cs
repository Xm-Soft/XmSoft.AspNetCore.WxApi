...
{
    /// <summary>
    /// AliApi API: koubei.retail.wms.producer.batchquery
    /// </summary>
    public class KoubeiRetailWmsProducerBatchqueryRequest : IAliApiRequest<KoubeiRetailWmsProducerBatchqueryResponse>
    {
        /// <summary>
        /// 口碑零售生产厂商信息批量查询
        /// </summary>
