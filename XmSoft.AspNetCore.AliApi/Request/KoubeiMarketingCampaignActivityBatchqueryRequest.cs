...
{
    /// <summary>
    /// AliApi API: koubei.marketing.campaign.activity.batchquery
    /// </summary>
    public class KoubeiMarketingCampaignActivityBatchqueryRequest : IAliApiRequest<KoubeiMarketingCampaignActivityBatchqueryResponse>
    {
        /// <summary>
        /// 口碑营销活动列表查询
        /// </summary>
