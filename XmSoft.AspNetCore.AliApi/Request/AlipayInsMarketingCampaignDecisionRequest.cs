...
{
    /// <summary>
    /// AliApi API: alipay.ins.marketing.campaign.decision
    /// </summary>
    public class AlipayInsMarketingCampaignDecisionRequest : IAliApiRequest<AlipayInsMarketingCampaignDecisionResponse>
    {
        /// <summary>
        /// 保险营销标的活动列表查询
        /// </summary>
