...
{
    /// <summary>
    /// AliApi API: alipay.open.public.matchuser.follow.query
    /// </summary>
    public class AlipayOpenPublicMatchuserFollowQueryRequest : IAliApiRequest<AlipayOpenPublicMatchuserFollowQueryResponse>
    {
        /// <summary>
        /// 生活号用户关注情况高级查询接口
        /// </summary>
