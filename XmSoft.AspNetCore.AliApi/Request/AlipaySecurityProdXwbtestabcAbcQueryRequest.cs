...
{
    /// <summary>
    /// AliApi API: alipay.security.prod.xwbtestabc.abc.query
    /// </summary>
    public class AlipaySecurityProdXwbtestabcAbcQueryRequest : IAliApiRequest<AlipaySecurityProdXwbtestabcAbcQueryResponse>
    {
        /// <summary>
        /// xuwebio测试用
        /// </summary>
