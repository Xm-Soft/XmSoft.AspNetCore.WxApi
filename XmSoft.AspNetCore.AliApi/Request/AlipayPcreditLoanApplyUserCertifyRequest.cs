...
{
    /// <summary>
    /// AliApi API: alipay.pcredit.loan.apply.user.certify
    /// </summary>
    public class AlipayPcreditLoanApplyUserCertifyRequest : IAliApiRequest<AlipayPcreditLoanApplyUserCertifyResponse>
    {
        /// <summary>
        /// 授信申请用户认证
        /// </summary>
