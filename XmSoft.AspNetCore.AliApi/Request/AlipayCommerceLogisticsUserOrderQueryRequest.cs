...
{
    /// <summary>
    /// AliApi API: alipay.commerce.logistics.user.order.query
    /// </summary>
    public class AlipayCommerceLogisticsUserOrderQueryRequest : IAliApiRequest<AlipayCommerceLogisticsUserOrderQueryResponse>
    {
        /// <summary>
        /// 用户业务订单查询
        /// </summary>
