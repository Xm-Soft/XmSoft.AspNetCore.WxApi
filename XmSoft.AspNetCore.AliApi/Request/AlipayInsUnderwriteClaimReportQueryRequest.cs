...
{
    /// <summary>
    /// AliApi API: alipay.ins.underwrite.claim.report.query
    /// </summary>
    public class AlipayInsUnderwriteClaimReportQueryRequest : IAliApiRequest<AlipayInsUnderwriteClaimReportQueryResponse>
    {
        /// <summary>
        /// 理赔案件信息查询
        /// </summary>
