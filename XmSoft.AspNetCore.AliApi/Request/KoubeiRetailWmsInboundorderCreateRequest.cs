...
{
    /// <summary>
    /// AliApi API: koubei.retail.wms.inboundorder.create
    /// </summary>
    public class KoubeiRetailWmsInboundorderCreateRequest : IAliApiRequest<KoubeiRetailWmsInboundorderCreateResponse>
    {
        /// <summary>
        /// 创建入库通知单
        /// </summary>
