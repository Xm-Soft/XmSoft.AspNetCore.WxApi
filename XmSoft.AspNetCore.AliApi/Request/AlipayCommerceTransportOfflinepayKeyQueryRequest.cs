...
{
    /// <summary>
    /// AliApi API: alipay.commerce.transport.offlinepay.key.query
    /// </summary>
    public class AlipayCommerceTransportOfflinepayKeyQueryRequest : IAliApiRequest<AlipayCommerceTransportOfflinepayKeyQueryResponse>
    {
