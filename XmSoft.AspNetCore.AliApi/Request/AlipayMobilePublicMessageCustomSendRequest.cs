...
{
    /// <summary>
    /// AliApi API: alipay.mobile.public.message.custom.send
    /// </summary>
    public class AlipayMobilePublicMessageCustomSendRequest : IAliApiRequest<AlipayMobilePublicMessageCustomSendResponse>
    {
        /// <summary>
