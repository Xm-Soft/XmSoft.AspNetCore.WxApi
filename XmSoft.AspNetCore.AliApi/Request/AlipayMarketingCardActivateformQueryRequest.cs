...
{
    /// <summary>
    /// AliApi API: alipay.marketing.card.activateform.query
    /// </summary>
    public class AlipayMarketingCardActivateformQueryRequest : IAliApiRequest<AlipayMarketingCardActivateformQueryResponse>
    {
        /// <summary>
        /// 查询用户授权的开放表单信息
        /// </summary>
