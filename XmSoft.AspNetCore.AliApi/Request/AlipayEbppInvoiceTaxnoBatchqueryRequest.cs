...
{
    /// <summary>
    /// AliApi API: alipay.ebpp.invoice.taxno.batchquery
    /// </summary>
    public class AlipayEbppInvoiceTaxnoBatchqueryRequest : IAliApiRequest<AlipayEbppInvoiceTaxnoBatchqueryResponse>
    {
        /// <summary>
        /// 获取指定企业税号的用户发票要素列表
        /// </summary>
