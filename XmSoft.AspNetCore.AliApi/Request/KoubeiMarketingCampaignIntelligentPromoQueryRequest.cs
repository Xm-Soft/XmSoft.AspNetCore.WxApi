...
{
    /// <summary>
    /// AliApi API: koubei.marketing.campaign.intelligent.promo.query
    /// </summary>
    public class KoubeiMarketingCampaignIntelligentPromoQueryRequest : IAliApiRequest<KoubeiMarketingCampaignIntelligentPromoQueryResponse>
    {
        /// <summary>
        /// 只能营销方案详情查询
        /// </summary>
