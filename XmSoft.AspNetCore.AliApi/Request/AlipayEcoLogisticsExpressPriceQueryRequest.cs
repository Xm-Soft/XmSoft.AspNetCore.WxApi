...
{
    /// <summary>
    /// AliApi API: alipay.eco.logistics.express.price.query
    /// </summary>
    public class AlipayEcoLogisticsExpressPriceQueryRequest : IAliApiRequest<AlipayEcoLogisticsExpressPriceQueryResponse>
    {
        /// <summary>
        /// 查询寄件价格接口
        /// </summary>
