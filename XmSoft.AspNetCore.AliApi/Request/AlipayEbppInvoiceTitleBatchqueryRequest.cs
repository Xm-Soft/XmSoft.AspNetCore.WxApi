...
{
    /// <summary>
    /// AliApi API: alipay.ebpp.invoice.title.batchquery
    /// </summary>
    public class AlipayEbppInvoiceTitleBatchqueryRequest : IAliApiRequest<AlipayEbppInvoiceTitleBatchqueryResponse>
    {
        /// <summary>
        /// 获取指定抬头的发票要素列表
        /// </summary>
