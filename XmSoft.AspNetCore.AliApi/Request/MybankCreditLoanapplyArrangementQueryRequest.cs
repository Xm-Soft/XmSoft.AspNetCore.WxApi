...
{
    /// <summary>
    /// AliApi API: mybank.credit.loanapply.arrangement.query
    /// </summary>
    public class MybankCreditLoanapplyArrangementQueryRequest : IAliApiRequest<MybankCreditLoanapplyArrangementQueryResponse>
    {
        /// <summary>
        /// 网商银行融资平台协议查询接口
        /// </summary>
