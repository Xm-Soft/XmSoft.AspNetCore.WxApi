...
{
    /// <summary>
    /// AliApi API: alipay.open.public.message.content.create
    /// </summary>
    public class AlipayOpenPublicMessageContentCreateRequest : IAliApiRequest<AlipayOpenPublicMessageContentCreateResponse>
    {
        /// <summary>
        /// 新增图文消息素材接口
        /// </summary>
