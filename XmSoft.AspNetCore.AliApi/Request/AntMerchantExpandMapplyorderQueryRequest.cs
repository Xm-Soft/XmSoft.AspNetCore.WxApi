...
{
    /// <summary>
    /// AliApi API: ant.merchant.expand.mapplyorder.query
    /// </summary>
    public class AntMerchantExpandMapplyorderQueryRequest : IAliApiRequest<AntMerchantExpandMapplyorderQueryResponse>
    {
        /// <summary>
        /// 商户入驻单查询接口
        /// </summary>
