...
{
    /// <summary>
    /// AliApi API: alipay.pcredit.loan.collateral.operation.sync
    /// </summary>
    public class AlipayPcreditLoanCollateralOperationSyncRequest : IAliApiUploadRequest<AlipayPcreditLoanCollateralOperationSyncResponse>
    {
        /// <summary>
