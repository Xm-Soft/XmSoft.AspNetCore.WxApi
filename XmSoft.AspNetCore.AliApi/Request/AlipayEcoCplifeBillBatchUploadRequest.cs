...
{
    /// <summary>
    /// AliApi API: alipay.eco.cplife.bill.batch.upload
    /// </summary>
    public class AlipayEcoCplifeBillBatchUploadRequest : IAliApiRequest<AlipayEcoCplifeBillBatchUploadResponse>
    {
        /// <summary>
        /// 物业费账单数据批量上传
        /// </summary>
