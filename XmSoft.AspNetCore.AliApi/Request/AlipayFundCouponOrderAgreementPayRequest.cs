...
{
    /// <summary>
    /// AliApi API: alipay.fund.coupon.order.agreement.pay
    /// </summary>
    public class AlipayFundCouponOrderAgreementPayRequest : IAliApiRequest<AlipayFundCouponOrderAgreementPayResponse>
    {
        /// <summary>
        /// 红包协议支付接口
        /// </summary>
