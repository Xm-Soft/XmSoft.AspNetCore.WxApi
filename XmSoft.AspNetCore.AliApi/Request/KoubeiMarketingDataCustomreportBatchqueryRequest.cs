...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.customreport.batchquery
    /// </summary>
    public class KoubeiMarketingDataCustomreportBatchqueryRequest : IAliApiRequest<KoubeiMarketingDataCustomreportBatchqueryResponse>
    {
        /// <summary>
        /// 自定义数据报表列表分页查询接口
        /// </summary>
