...
{
    /// <summary>
    /// AliApi API: alipay.ebpp.invoice.info.applyid.query
    /// </summary>
    public class AlipayEbppInvoiceInfoApplyidQueryRequest : IAliApiRequest<AlipayEbppInvoiceInfoApplyidQueryResponse>
    {
        /// <summary>
        /// 根据发票申请id查询发票信息
        /// </summary>
