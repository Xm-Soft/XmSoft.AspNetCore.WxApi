...
{
    /// <summary>
    /// AliApi API: alipay.ebpp.invoice.merchantlist.enter.apply
    /// </summary>
    public class AlipayEbppInvoiceMerchantlistEnterApplyRequest : IAliApiRequest<AlipayEbppInvoiceMerchantlistEnterApplyResponse>
    {
        /// <summary>
        /// 商户批量入驻申请接口
        /// </summary>
