...
{
    /// <summary>
    /// AliApi API: koubei.retail.wms.supplierreport.query
    /// </summary>
    public class KoubeiRetailWmsSupplierreportQueryRequest : IAliApiRequest<KoubeiRetailWmsSupplierreportQueryResponse>
    {
        /// <summary>
        /// 供货商盘点单分页查询
        /// </summary>
