...
{
    /// <summary>
    /// AliApi API: alipay.commerce.transport.ad.plan.create
    /// </summary>
    public class AlipayCommerceTransportAdPlanCreateRequest : IAliApiRequest<AlipayCommerceTransportAdPlanCreateResponse>
    {
        /// <summary>
        /// 出行广告计划添加
        /// </summary>
