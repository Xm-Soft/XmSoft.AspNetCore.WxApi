...
{
    /// <summary>
    /// AliApi API: alipay.ins.scene.application.issue.confirm
    /// </summary>
    public class AlipayInsSceneApplicationIssueConfirmRequest : IAliApiRequest<AlipayInsSceneApplicationIssueConfirmResponse>
    {
        /// <summary>
        /// 投保订单出单确认
        /// </summary>
