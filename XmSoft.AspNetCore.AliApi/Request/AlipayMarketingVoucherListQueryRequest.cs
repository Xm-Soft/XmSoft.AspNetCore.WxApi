...
{
    /// <summary>
    /// AliApi API: alipay.marketing.voucher.list.query
    /// </summary>
    public class AlipayMarketingVoucherListQueryRequest : IAliApiRequest<AlipayMarketingVoucherListQueryResponse>
    {
        /// <summary>
        /// 查询券列表
        /// </summary>
