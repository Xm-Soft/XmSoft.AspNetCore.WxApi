...
{
    /// <summary>
    /// AliApi API: koubei.marketing.campaign.recruit.shop.query
    /// </summary>
    public class KoubeiMarketingCampaignRecruitShopQueryRequest : IAliApiRequest<KoubeiMarketingCampaignRecruitShopQueryResponse>
    {
        /// <summary>
        /// 招商门店分页查询接口
        /// </summary>
