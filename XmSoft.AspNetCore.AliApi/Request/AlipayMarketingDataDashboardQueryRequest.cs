...
{
    /// <summary>
    /// AliApi API: alipay.marketing.data.dashboard.query
    /// </summary>
    public class AlipayMarketingDataDashboardQueryRequest : IAliApiRequest<AlipayMarketingDataDashboardQueryResponse>
    {
        /// <summary>
        /// 仪表盘查询
        /// </summary>
