...
{
    /// <summary>
    /// AliApi API: alipay.pcredit.loan.repay.result.query
    /// </summary>
    public class AlipayPcreditLoanRepayResultQueryRequest : IAliApiRequest<AlipayPcreditLoanRepayResultQueryResponse>
    {
        /// <summary>
        /// 查询还款结果
        /// </summary>
