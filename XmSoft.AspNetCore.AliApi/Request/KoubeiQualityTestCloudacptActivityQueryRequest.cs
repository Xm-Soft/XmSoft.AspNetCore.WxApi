...
{
    /// <summary>
    /// AliApi API: koubei.quality.test.cloudacpt.activity.query
    /// </summary>
    public class KoubeiQualityTestCloudacptActivityQueryRequest : IAliApiRequest<KoubeiQualityTestCloudacptActivityQueryResponse>
    {
        /// <summary>
        /// 云验收活动列表查询
        /// </summary>
