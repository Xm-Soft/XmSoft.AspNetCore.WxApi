...
{
    /// <summary>
    /// AliApi API: alipay.offline.provider.monitor.log.sync
    /// </summary>
    public class AlipayOfflineProviderMonitorLogSyncRequest : IAliApiRequest<AlipayOfflineProviderMonitorLogSyncResponse>
    {
        /// <summary>
        /// ISV服务商监控数据回流
        /// </summary>
