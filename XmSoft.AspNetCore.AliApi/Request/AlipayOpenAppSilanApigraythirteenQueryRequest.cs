...
{
    /// <summary>
    /// AliApi API: alipay.open.app.silan.apigraythirteen.query
    /// </summary>
    public class AlipayOpenAppSilanApigraythirteenQueryRequest : IAliApiRequest<AlipayOpenAppSilanApigraythirteenQueryResponse>
    {
