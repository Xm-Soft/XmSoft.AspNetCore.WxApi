...
{
    /// <summary>
    /// AliApi API: alipay.ebpp.invoice.expense.progress.sync
    /// </summary>
    public class AlipayEbppInvoiceExpenseProgressSyncRequest : IAliApiRequest<AlipayEbppInvoiceExpenseProgressSyncResponse>
    {
        /// <summary>
        /// 发票报销处理进度同步
        /// </summary>
