...
{
    /// <summary>
    /// AliApi API: alipay.account.exrate.collectcore.data.send
    /// </summary>
    public class AlipayAccountExrateCollectcoreDataSendRequest : IAliApiRequest<AlipayAccountExrateCollectcoreDataSendResponse>
    {
        /// <summary>
        /// 金融信息受理接口
        /// </summary>
