...
{
    /// <summary>
    /// AliApi API: alipay.open.mini.version.build.query
    /// </summary>
    public class AlipayOpenMiniVersionBuildQueryRequest : IAliApiRequest<AlipayOpenMiniVersionBuildQueryResponse>
    {
        /// <summary>
        /// 小程序构建状态查询
        /// </summary>
