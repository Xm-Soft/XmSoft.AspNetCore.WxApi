...
{
    /// <summary>
    /// AliApi API: alipay.marketing.card.formtemplate.set
    /// </summary>
    public class AlipayMarketingCardFormtemplateSetRequest : IAliApiRequest<AlipayMarketingCardFormtemplateSetResponse>
    {
        /// <summary>
        /// 开卡组件表单配置
        /// </summary>
