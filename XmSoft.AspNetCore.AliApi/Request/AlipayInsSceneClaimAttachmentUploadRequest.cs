...
{
    /// <summary>
    /// AliApi API: alipay.ins.scene.claim.attachment.upload
    /// </summary>
    public class AlipayInsSceneClaimAttachmentUploadRequest : IAliApiUploadRequest<AlipayInsSceneClaimAttachmentUploadResponse>
    {
        /// <summary>
        /// 案件材料名称
        /// </summary>
