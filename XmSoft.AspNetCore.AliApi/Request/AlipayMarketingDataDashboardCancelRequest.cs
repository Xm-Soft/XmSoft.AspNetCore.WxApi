...
{
    /// <summary>
    /// AliApi API: alipay.marketing.data.dashboard.cancel
    /// </summary>
    public class AlipayMarketingDataDashboardCancelRequest : IAliApiRequest<AlipayMarketingDataDashboardCancelResponse>
    {
        /// <summary>
        /// 仪表盘取消授权
        /// </summary>
