...
{
    /// <summary>
    /// AliApi API: alipay.open.mini.version.list.query
    /// </summary>
    public class AlipayOpenMiniVersionListQueryRequest : IAliApiRequest<AlipayOpenMiniVersionListQueryResponse>
    {
