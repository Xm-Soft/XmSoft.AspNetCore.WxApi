...
{
    /// <summary>
    /// AliApi API: alipay.security.prod.signature.task.apply
    /// </summary>
    public class AlipaySecurityProdSignatureTaskApplyRequest : IAliApiRequest<AlipaySecurityProdSignatureTaskApplyResponse>
    {
        /// <summary>
        /// 支付宝可信电子签名申请
        /// </summary>
