...
{
    /// <summary>
    /// AliApi API: alipay.marketing.cdp.advertise.operate
    /// </summary>
    public class AlipayMarketingCdpAdvertiseOperateRequest : IAliApiRequest<AlipayMarketingCdpAdvertiseOperateResponse>
    {
        /// <summary>
        /// 提供给ISV、开发者操作广告的接口
        /// </summary>
