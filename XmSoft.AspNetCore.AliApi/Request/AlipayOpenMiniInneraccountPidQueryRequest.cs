...
{
    /// <summary>
    /// AliApi API: alipay.open.mini.inneraccount.pid.query
    /// </summary>
    public class AlipayOpenMiniInneraccountPidQueryRequest : IAliApiRequest<AlipayOpenMiniInneraccountPidQueryResponse>
    {
        /// <summary>
        /// 查询小程序管理员虚拟 ID
        /// </summary>
