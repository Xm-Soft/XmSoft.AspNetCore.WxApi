...
{
    /// <summary>
    /// AliApi API: alipay.marketing.cdp.advertise.query
    /// </summary>
    public class AlipayMarketingCdpAdvertiseQueryRequest : IAliApiRequest<AlipayMarketingCdpAdvertiseQueryResponse>
    {
        /// <summary>
        /// 提供给ISV和开发者查询广告的接口
        /// </summary>
