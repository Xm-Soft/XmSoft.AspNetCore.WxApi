...
{
    /// <summary>
    /// AliApi API: alipay.open.servicemarket.order.create
    /// </summary>
    public class AlipayOpenServicemarketOrderCreateRequest : IAliApiUploadRequest<AlipayOpenServicemarketOrderCreateResponse>
    {
        /// <summary>
