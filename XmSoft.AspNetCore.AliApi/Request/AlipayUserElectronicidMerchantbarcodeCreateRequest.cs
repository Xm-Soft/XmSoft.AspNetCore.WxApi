...
{
    /// <summary>
    /// AliApi API: alipay.user.electronicid.merchantbarcode.create
    /// </summary>
    public class AlipayUserElectronicidMerchantbarcodeCreateRequest : IAliApiRequest<AlipayUserElectronicidMerchantbarcodeCreateResponse>
    {
        /// <summary>
        /// 创建证件商户二维码
        /// </summary>
