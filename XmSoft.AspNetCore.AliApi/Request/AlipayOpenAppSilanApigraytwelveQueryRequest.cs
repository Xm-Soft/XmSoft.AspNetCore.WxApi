...
{
    /// <summary>
    /// AliApi API: alipay.open.app.silan.apigraytwelve.query
    /// </summary>
    public class AlipayOpenAppSilanApigraytwelveQueryRequest : IAliApiRequest<AlipayOpenAppSilanApigraytwelveQueryResponse>
    {
