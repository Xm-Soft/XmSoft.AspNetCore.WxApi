...
{
    /// <summary>
    /// AliApi API: alipay.ebpp.invoice.detail.output.query
    /// </summary>
    public class AlipayEbppInvoiceDetailOutputQueryRequest : IAliApiRequest<AlipayEbppInvoiceDetailOutputQueryResponse>
    {
        /// <summary>
        /// 获取报销发票详细信息
        /// </summary>
