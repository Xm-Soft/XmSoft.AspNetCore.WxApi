...
{
    /// <summary>
    /// AliApi API: alipay.ebpp.invoice.file.sync.retry
    /// </summary>
    public class AlipayEbppInvoiceFileSyncRetryRequest : IAliApiRequest<AlipayEbppInvoiceFileSyncRetryResponse>
    {
        /// <summary>
        /// 文件同步补偿接口
        /// </summary>
