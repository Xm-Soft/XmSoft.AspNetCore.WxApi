...
{
    /// <summary>
    /// AliApi API: alipay.eco.entertainment.order.upload
    /// </summary>
    public class AlipayEcoEntertainmentOrderUploadRequest : IAliApiRequest<AlipayEcoEntertainmentOrderUploadResponse>
    {
        /// <summary>
        /// 数娱充值平台ISV订单回流接口
        /// </summary>
