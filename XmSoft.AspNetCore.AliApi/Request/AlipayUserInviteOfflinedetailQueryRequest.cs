...
{
    /// <summary>
    /// AliApi API: alipay.user.invite.offlinedetail.query
    /// </summary>
    public class AlipayUserInviteOfflinedetailQueryRequest : IAliApiRequest<AlipayUserInviteOfflinedetailQueryResponse>
    {
        /// <summary>
        /// 线下拉新结算明细数据查询
        /// </summary>
