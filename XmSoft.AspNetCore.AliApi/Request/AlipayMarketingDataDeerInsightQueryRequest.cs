...
{
    /// <summary>
    /// AliApi API: alipay.marketing.data.deer.insight.query
    /// </summary>
    public class AlipayMarketingDataDeerInsightQueryRequest : IAliApiRequest<AlipayMarketingDataDeerInsightQueryResponse>
    {
        /// <summary>
        /// 获取 H5 活动洞察信息
        /// </summary>
