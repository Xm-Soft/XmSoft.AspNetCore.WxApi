...
{
    /// <summary>
    /// AliApi API: alipay.ins.cooperation.product.offline.batchquery
    /// </summary>
    public class AlipayInsCooperationProductOfflineBatchqueryRequest : IAliApiRequest<AlipayInsCooperationProductOfflineBatchqueryResponse>
    {
        /// <summary>
        /// （快捷投保）查询该保险公司的线下产品列表
        /// </summary>
