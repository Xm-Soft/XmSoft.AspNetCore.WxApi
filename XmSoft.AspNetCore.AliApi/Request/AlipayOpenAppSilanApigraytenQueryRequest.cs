...
{
    /// <summary>
    /// AliApi API: alipay.open.app.silan.apigrayten.query
    /// </summary>
    public class AlipayOpenAppSilanApigraytenQueryRequest : IAliApiRequest<AlipayOpenAppSilanApigraytenQueryResponse>
    {
