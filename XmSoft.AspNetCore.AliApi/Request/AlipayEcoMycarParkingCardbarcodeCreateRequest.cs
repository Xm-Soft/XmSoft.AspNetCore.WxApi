...
{
    /// <summary>
    /// AliApi API: alipay.eco.mycar.parking.cardbarcode.create
    /// </summary>
    public class AlipayEcoMycarParkingCardbarcodeCreateRequest : IAliApiRequest<AlipayEcoMycarParkingCardbarcodeCreateResponse>
    {
        /// <summary>
        /// 停车卡生成二维码
        /// </summary>
