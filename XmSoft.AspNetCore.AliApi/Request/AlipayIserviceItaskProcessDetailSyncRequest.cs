...
{
    /// <summary>
    /// AliApi API: alipay.iservice.itask.process.detail.sync
    /// </summary>
    public class AlipayIserviceItaskProcessDetailSyncRequest : IAliApiRequest<AlipayIserviceItaskProcessDetailSyncResponse>
    {
        /// <summary>
        /// 外部工单完结同步接口
        /// </summary>
