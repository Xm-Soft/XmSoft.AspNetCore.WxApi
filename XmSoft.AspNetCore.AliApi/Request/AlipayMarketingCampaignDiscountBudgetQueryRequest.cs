...
{
    /// <summary>
    /// AliApi API: alipay.marketing.campaign.discount.budget.query
    /// </summary>
    public class AlipayMarketingCampaignDiscountBudgetQueryRequest : IAliApiRequest<AlipayMarketingCampaignDiscountBudgetQueryResponse>
    {
        /// <summary>
        /// 营销立减活动预算查询
        /// </summary>
