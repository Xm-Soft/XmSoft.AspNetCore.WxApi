...
{
    /// <summary>
    /// AliApi API: alipay.overseas.travel.exchangerate.query
    /// </summary>
    public class AlipayOverseasTravelExchangerateQueryRequest : IAliApiRequest<AlipayOverseasTravelExchangerateQueryResponse>
    {
        /// <summary>
        /// 跨境游单个汇率查询接口
        /// </summary>
