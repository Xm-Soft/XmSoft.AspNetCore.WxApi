...
{
    /// <summary>
    /// AliApi API: koubei.marketing.campaign.recruit.apply.query
    /// </summary>
    public class KoubeiMarketingCampaignRecruitApplyQueryRequest : IAliApiRequest<KoubeiMarketingCampaignRecruitApplyQueryResponse>
    {
        /// <summary>
        /// 招商商家报名分页查询接口
        /// </summary>
