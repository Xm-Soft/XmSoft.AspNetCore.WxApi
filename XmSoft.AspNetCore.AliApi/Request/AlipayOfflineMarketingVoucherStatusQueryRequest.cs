...
{
    /// <summary>
    /// AliApi API: alipay.offline.marketing.voucher.status.query
    /// </summary>
    public class AlipayOfflineMarketingVoucherStatusQueryRequest : IAliApiRequest<AlipayOfflineMarketingVoucherStatusQueryResponse>
    {
        /// <summary>
        /// 券状态查询
        /// </summary>
