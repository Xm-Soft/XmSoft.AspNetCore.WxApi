...
{
    /// <summary>
    /// AliApi API: alipay.boss.cs.cssocial.yqmessage.query
    /// </summary>
    public class AlipayBossCsCssocialYqmessageQueryRequest : IAliApiRequest<AlipayBossCsCssocialYqmessageQueryResponse>
    {
        /// <summary>
        /// 舆情数据通用搜索
        /// </summary>
