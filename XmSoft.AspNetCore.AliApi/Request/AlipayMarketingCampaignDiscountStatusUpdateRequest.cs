...
{
    /// <summary>
    /// AliApi API: alipay.marketing.campaign.discount.status.update
    /// </summary>
    public class AlipayMarketingCampaignDiscountStatusUpdateRequest : IAliApiRequest<AlipayMarketingCampaignDiscountStatusUpdateResponse>
    {
        /// <summary>
        /// 优惠活动状态修改
        /// </summary>
