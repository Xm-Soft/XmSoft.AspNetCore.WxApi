...
{
    /// <summary>
    /// AliApi API: alipay.open.public.life.label.create
    /// </summary>
    public class AlipayOpenPublicLifeLabelCreateRequest : IAliApiRequest<AlipayOpenPublicLifeLabelCreateResponse>
    {
        /// <summary>
        /// 创建标签接口
        /// </summary>
