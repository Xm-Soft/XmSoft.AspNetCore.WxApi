...
{
    /// <summary>
    /// AliApi API: alipay.user.certify.open.initialize
    /// </summary>
    public class AlipayUserCertifyOpenInitializeRequest : IAliApiRequest<AlipayUserCertifyOpenInitializeResponse>
    {
        /// <summary>
        /// 支付宝开放认证初始化服务
        /// </summary>
