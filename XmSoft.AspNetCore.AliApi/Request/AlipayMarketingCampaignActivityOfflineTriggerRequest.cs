...
{
    /// <summary>
    /// AliApi API: alipay.marketing.campaign.activity.offline.trigger
    /// </summary>
    public class AlipayMarketingCampaignActivityOfflineTriggerRequest : IAliApiRequest<AlipayMarketingCampaignActivityOfflineTriggerResponse>
    {
        /// <summary>
        /// 商户创建活动后，需营销核心平台，来发奖。
        /// </summary>
