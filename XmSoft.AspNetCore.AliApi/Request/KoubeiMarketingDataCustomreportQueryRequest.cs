...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.customreport.query
    /// </summary>
    public class KoubeiMarketingDataCustomreportQueryRequest : IAliApiRequest<KoubeiMarketingDataCustomreportQueryResponse>
    {
        /// <summary>
        /// 自定义数据报表数据查询接口
        /// </summary>
