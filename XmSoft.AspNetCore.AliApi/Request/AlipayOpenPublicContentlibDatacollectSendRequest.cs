...
{
    /// <summary>
    /// AliApi API: alipay.open.public.contentlib.datacollect.send
    /// </summary>
    public class AlipayOpenPublicContentlibDatacollectSendRequest : IAliApiRequest<AlipayOpenPublicContentlibDatacollectSendResponse>
    {
        /// <summary>
        /// 内容中台爬虫数据推送接口
        /// </summary>
