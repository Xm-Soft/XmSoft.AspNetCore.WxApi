...
{
    /// <summary>
    /// AliApi API: alipay.commerce.cityfacilitator.script.query
    /// </summary>
    public class AlipayCommerceCityfacilitatorScriptQueryRequest : IAliApiRequest<AlipayCommerceCityfacilitatorScriptQueryResponse>
    {
        /// <summary>
        /// 查询城市一卡通的判卡、读卡脚本
        /// </summary>
