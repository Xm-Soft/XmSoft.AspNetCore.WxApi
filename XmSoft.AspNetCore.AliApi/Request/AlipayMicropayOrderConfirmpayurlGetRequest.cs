...
{
    /// <summary>
    /// AliApi API: alipay.micropay.order.confirmpayurl.get
    /// </summary>
    public class AlipayMicropayOrderConfirmpayurlGetRequest : IAliApiRequest<AlipayMicropayOrderConfirmpayurlGetResponse>
    {
        /// <summary>
