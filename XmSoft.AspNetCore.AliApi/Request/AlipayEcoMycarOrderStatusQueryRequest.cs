...
{
    /// <summary>
    /// AliApi API: alipay.eco.mycar.order.status.query
    /// </summary>
    public class AlipayEcoMycarOrderStatusQueryRequest : IAliApiRequest<AlipayEcoMycarOrderStatusQueryResponse>
    {
        /// <summary>
        /// 停车卡查询收费信息
        /// </summary>
