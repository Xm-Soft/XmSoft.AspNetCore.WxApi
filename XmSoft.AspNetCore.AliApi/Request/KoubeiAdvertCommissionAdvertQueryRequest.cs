...
{
    /// <summary>
    /// AliApi API: koubei.advert.commission.advert.query
    /// </summary>
    public class KoubeiAdvertCommissionAdvertQueryRequest : IAliApiRequest<KoubeiAdvertCommissionAdvertQueryResponse>
    {
        /// <summary>
        /// 分佣推广信息查询接口
        /// </summary>
