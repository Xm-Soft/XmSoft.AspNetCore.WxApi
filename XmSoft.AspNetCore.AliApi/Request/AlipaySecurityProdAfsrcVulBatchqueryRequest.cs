...
{
    /// <summary>
    /// AliApi API: alipay.security.prod.afsrc.vul.batchquery
    /// </summary>
    public class AlipaySecurityProdAfsrcVulBatchqueryRequest : IAliApiRequest<AlipaySecurityProdAfsrcVulBatchqueryResponse>
    {
        /// <summary>
        /// 白帽子漏洞批量查询接口
        /// </summary>
