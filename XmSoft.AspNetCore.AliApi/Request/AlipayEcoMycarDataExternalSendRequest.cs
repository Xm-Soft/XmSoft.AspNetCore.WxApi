...
{
    /// <summary>
    /// AliApi API: alipay.eco.mycar.data.external.send
    /// </summary>
    public class AlipayEcoMycarDataExternalSendRequest : IAliApiRequest<AlipayEcoMycarDataExternalSendResponse>
    {
        /// <summary>
        /// 行业平台写请求
        /// </summary>
