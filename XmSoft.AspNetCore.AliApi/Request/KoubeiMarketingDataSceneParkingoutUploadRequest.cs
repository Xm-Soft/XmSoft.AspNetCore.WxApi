...
{
    /// <summary>
    /// AliApi API: koubei.marketing.data.scene.parkingout.upload
    /// </summary>
    public class KoubeiMarketingDataSceneParkingoutUploadRequest : IAliApiRequest<KoubeiMarketingDataSceneParkingoutUploadResponse>
    {
        /// <summary>
